import{S as E,i as C,s as N,k as A,l as D,m as O,h as u,n as k,Q as Tt,b as f,R as Ee,T as me,B as V,J as oe,D as mt,q as ue,r as de,I as ae,u as ve,U as ut,V as _t,o as dt,e as y,g as R,t as h,d as M,f as d,W as Ce,X as le,Y as Pt,w as z,x as W,y as B,Z as he,_ as pe,z as $,v as K,a as X,c as ee,$ as xt,L,M as j,N as F,O as H,H as _e,a0 as It,a1 as At,a2 as Dt,a3 as zt,K as De,a4 as Ne,a5 as Re,a6 as Se,a7 as be,P as Bt,a8 as ye}from"../../chunks/index-46152244.js";import{d as $t,w as Ot}from"../../chunks/index-6a6d7a4c.js";import{c as ht}from"../../chunks/store-fe87f594.js";function Me(o,e,n){const i=o.slice();return i[4]=e[n],i}function Ge(o){let e,n=o[4].replaceAll("_"," ")+"",i,t;return{c(){e=A("option"),i=ue(n),this.h()},l(r){e=D(r,"OPTION",{});var a=O(e);i=de(a,n),a.forEach(u),this.h()},h(){e.__value=t=o[4],e.value=e.__value},m(r,a){f(r,e,a),ae(e,i)},p(r,a){a&2&&n!==(n=r[4].replaceAll("_"," ")+"")&&ve(i,n),a&2&&t!==(t=r[4])&&(e.__value=t,e.value=e.__value)},d(r){r&&u(e)}}}function Et(o){let e,n,i,t=o[1],r=[];for(let a=0;a<t.length;a+=1)r[a]=Ge(Me(o,t,a));return{c(){e=A("select");for(let a=0;a<r.length;a+=1)r[a].c();this.h()},l(a){e=D(a,"SELECT",{id:!0,class:!0});var l=O(e);for(let s=0;s<r.length;s+=1)r[s].l(l);l.forEach(u),this.h()},h(){k(e,"id","select"),k(e,"class","svelte-1i9xen5"),o[0]===void 0&&Tt(()=>o[3].call(e))},m(a,l){f(a,e,l);for(let s=0;s<r.length;s+=1)r[s].m(e,null);Ee(e,o[0]),n||(i=[me(e,"change",o[2]),me(e,"change",o[3])],n=!0)},p(a,[l]){if(l&2){t=a[1];let s;for(s=0;s<t.length;s+=1){const c=Me(a,t,s);r[s]?r[s].p(c,l):(r[s]=Ge(c),r[s].c(),r[s].m(e,null))}for(;s<r.length;s+=1)r[s].d(1);r.length=t.length}l&3&&Ee(e,a[0])},i:V,o:V,d(a){a&&u(e),oe(r,a),n=!1,mt(i)}}}function Ct(o,e,n){let{selectedGuide:i=""}=e,{options:t}=e;function r(l){ut.call(this,o,l)}function a(){i=_t(this),n(0,i),n(1,t)}return o.$$set=l=>{"selectedGuide"in l&&n(0,i=l.selectedGuide),"options"in l&&n(1,t=l.options)},[i,t,r,a]}class Nt extends E{constructor(e){super(),C(this,e,Ct,Et,N,{selectedGuide:0,options:1})}}function Rt(){const o=console.warn;console.warn=e=>{e.includes("unknown prop")||e.includes("unexpected slot")||o(e)},dt(()=>{console.warn=o})}function qe(o,e,n){const i=o.slice();return i[18]=e[n],i}function We(o,e,n){const i=o.slice();return i[18]=e[n],i}function Ke(o,e,n){const i=o.slice();return i[10]=e[n],i}function Le(o,e,n){const i=o.slice();return i[13]=e[n],i[15]=n,i}function je(o,e,n){const i=o.slice();return i[16]=e[n],i[15]=n,i}function Fe(o,e,n){const i=o.slice();return i[7]=e[n],i}function Mt(o){let e,n,i,t;const r=[Kt,Wt,qt],a=[];function l(s,c){return s[0]==="table"?0:s[0]==="list"?1:2}return e=l(o),n=a[e]=r[e](o),{c(){n.c(),i=y()},l(s){n.l(s),i=y()},m(s,c){a[e].m(s,c),f(s,i,c),t=!0},p(s,c){let m=e;e=l(s),e===m?a[e].p(s,c):(R(),h(a[m],1,1,()=>{a[m]=null}),M(),n=a[e],n?n.p(s,c):(n=a[e]=r[e](s),n.c()),d(n,1),n.m(i.parentNode,i))},i(s){t||(d(n),t=!0)},o(s){h(n),t=!1},d(s){a[e].d(s),s&&u(i)}}}function Gt(o){let e,n,i=o[1],t=[];for(let a=0;a<i.length;a+=1)t[a]=Qe(Fe(o,i,a));const r=a=>h(t[a],1,1,()=>{t[a]=null});return{c(){for(let a=0;a<t.length;a+=1)t[a].c();e=y()},l(a){for(let l=0;l<t.length;l+=1)t[l].l(a);e=y()},m(a,l){for(let s=0;s<t.length;s+=1)t[s].m(a,l);f(a,e,l),n=!0},p(a,l){if(l&34){i=a[1];let s;for(s=0;s<i.length;s+=1){const c=Fe(a,i,s);t[s]?(t[s].p(c,l),d(t[s],1)):(t[s]=Qe(c),t[s].c(),d(t[s],1),t[s].m(e.parentNode,e))}for(R(),s=i.length;s<t.length;s+=1)r(s);M()}},i(a){if(!n){for(let l=0;l<i.length;l+=1)d(t[l]);n=!0}},o(a){t=t.filter(Boolean);for(let l=0;l<t.length;l+=1)h(t[l]);n=!1},d(a){oe(t,a),a&&u(e)}}}function qt(o){let e,n,i;const t=[o[6]];var r=o[5][o[0]];function a(l){let s={$$slots:{default:[Ft]},$$scope:{ctx:l}};for(let c=0;c<t.length;c+=1)s=le(s,t[c]);return{props:s}}return r&&(e=K(r,a(o))),{c(){e&&z(e.$$.fragment),n=y()},l(l){e&&W(e.$$.fragment,l),n=y()},m(l,s){e&&B(e,l,s),f(l,n,s),i=!0},p(l,s){const c=s&64?he(t,[pe(l[6])]):{};if(s&8388706&&(c.$$scope={dirty:s,ctx:l}),r!==(r=l[5][l[0]])){if(e){R();const m=e;h(m.$$.fragment,1,0,()=>{$(m,1)}),M()}r?(e=K(r,a(l)),z(e.$$.fragment),d(e.$$.fragment,1),B(e,n.parentNode,n)):e=null}else r&&e.$set(c)},i(l){i||(e&&d(e.$$.fragment,l),i=!0)},o(l){e&&h(e.$$.fragment,l),i=!1},d(l){l&&u(n),e&&$(e,l)}}}function Wt(o){let e,n,i,t;const r=[Vt,Ht],a=[];function l(s,c){return s[4]?0:1}return e=l(o),n=a[e]=r[e](o),{c(){n.c(),i=y()},l(s){n.l(s),i=y()},m(s,c){a[e].m(s,c),f(s,i,c),t=!0},p(s,c){let m=e;e=l(s),e===m?a[e].p(s,c):(R(),h(a[m],1,1,()=>{a[m]=null}),M(),n=a[e],n?n.p(s,c):(n=a[e]=r[e](s),n.c()),d(n,1),n.m(i.parentNode,i))},i(s){t||(d(n),t=!0)},o(s){h(n),t=!1},d(s){a[e].d(s),s&&u(i)}}}function Kt(o){let e,n,i;var t=o[5].table;function r(a){return{props:{$$slots:{default:[an]},$$scope:{ctx:a}}}}return t&&(e=K(t,r(o))),{c(){e&&z(e.$$.fragment),n=y()},l(a){e&&W(e.$$.fragment,a),n=y()},m(a,l){e&&B(e,a,l),f(a,n,l),i=!0},p(a,l){const s={};if(l&8388716&&(s.$$scope={dirty:l,ctx:a}),t!==(t=a[5].table)){if(e){R();const c=e;h(c.$$.fragment,1,0,()=>{$(c,1)}),M()}t?(e=K(t,r(a)),z(e.$$.fragment),d(e.$$.fragment,1),B(e,n.parentNode,n)):e=null}else t&&e.$set(s)},i(a){i||(e&&d(e.$$.fragment,a),i=!0)},o(a){e&&h(e.$$.fragment,a),i=!1},d(a){a&&u(n),e&&$(e,a)}}}function Lt(o){let e=o[6].raw+"",n;return{c(){n=ue(e)},l(i){n=de(i,e)},m(i,t){f(i,n,t)},p(i,t){t&64&&e!==(e=i[6].raw+"")&&ve(n,e)},i:V,o:V,d(i){i&&u(n)}}}function jt(o){let e,n;return e=new ce({props:{tokens:o[1],renderers:o[5]}}),{c(){z(e.$$.fragment)},l(i){W(e.$$.fragment,i)},m(i,t){B(e,i,t),n=!0},p(i,t){const r={};t&2&&(r.tokens=i[1]),t&32&&(r.renderers=i[5]),e.$set(r)},i(i){n||(d(e.$$.fragment,i),n=!0)},o(i){h(e.$$.fragment,i),n=!1},d(i){$(e,i)}}}function Ft(o){let e,n,i,t;const r=[jt,Lt],a=[];function l(s,c){return s[1]?0:1}return e=l(o),n=a[e]=r[e](o),{c(){n.c(),i=y()},l(s){n.l(s),i=y()},m(s,c){a[e].m(s,c),f(s,i,c),t=!0},p(s,c){let m=e;e=l(s),e===m?a[e].p(s,c):(R(),h(a[m],1,1,()=>{a[m]=null}),M(),n=a[e],n?n.p(s,c):(n=a[e]=r[e](s),n.c()),d(n,1),n.m(i.parentNode,i))},i(s){t||(d(n),t=!0)},o(s){h(n),t=!1},d(s){a[e].d(s),s&&u(i)}}}function Ht(o){let e,n,i;const t=[{ordered:o[4]},o[6]];var r=o[5].list;function a(l){let s={$$slots:{default:[Jt]},$$scope:{ctx:l}};for(let c=0;c<t.length;c+=1)s=le(s,t[c]);return{props:s}}return r&&(e=K(r,a(o))),{c(){e&&z(e.$$.fragment),n=y()},l(l){e&&W(e.$$.fragment,l),n=y()},m(l,s){e&&B(e,l,s),f(l,n,s),i=!0},p(l,s){const c=s&80?he(t,[s&16&&{ordered:l[4]},s&64&&pe(l[6])]):{};if(s&8388704&&(c.$$scope={dirty:s,ctx:l}),r!==(r=l[5].list)){if(e){R();const m=e;h(m.$$.fragment,1,0,()=>{$(m,1)}),M()}r?(e=K(r,a(l)),z(e.$$.fragment),d(e.$$.fragment,1),B(e,n.parentNode,n)):e=null}else r&&e.$set(c)},i(l){i||(e&&d(e.$$.fragment,l),i=!0)},o(l){e&&h(e.$$.fragment,l),i=!1},d(l){l&&u(n),e&&$(e,l)}}}function Vt(o){let e,n,i;const t=[{ordered:o[4]},o[6]];var r=o[5].list;function a(l){let s={$$slots:{default:[Qt]},$$scope:{ctx:l}};for(let c=0;c<t.length;c+=1)s=le(s,t[c]);return{props:s}}return r&&(e=K(r,a(o))),{c(){e&&z(e.$$.fragment),n=y()},l(l){e&&W(e.$$.fragment,l),n=y()},m(l,s){e&&B(e,l,s),f(l,n,s),i=!0},p(l,s){const c=s&80?he(t,[s&16&&{ordered:l[4]},s&64&&pe(l[6])]):{};if(s&8388704&&(c.$$scope={dirty:s,ctx:l}),r!==(r=l[5].list)){if(e){R();const m=e;h(m.$$.fragment,1,0,()=>{$(m,1)}),M()}r?(e=K(r,a(l)),z(e.$$.fragment),d(e.$$.fragment,1),B(e,n.parentNode,n)):e=null}else r&&e.$set(c)},i(l){i||(e&&d(e.$$.fragment,l),i=!0)},o(l){e&&h(e.$$.fragment,l),i=!1},d(l){l&&u(n),e&&$(e,l)}}}function Ut(o){let e,n,i;return e=new ce({props:{tokens:o[18].tokens,renderers:o[5]}}),{c(){z(e.$$.fragment),n=X()},l(t){W(e.$$.fragment,t),n=ee(t)},m(t,r){B(e,t,r),f(t,n,r),i=!0},p(t,r){const a={};r&64&&(a.tokens=t[18].tokens),r&32&&(a.renderers=t[5]),e.$set(a)},i(t){i||(d(e.$$.fragment,t),i=!0)},o(t){h(e.$$.fragment,t),i=!1},d(t){$(e,t),t&&u(n)}}}function He(o){let e,n,i;const t=[o[18]];var r=o[5].unorderedlistitem||o[5].listitem;function a(l){let s={$$slots:{default:[Ut]},$$scope:{ctx:l}};for(let c=0;c<t.length;c+=1)s=le(s,t[c]);return{props:s}}return r&&(e=K(r,a(o))),{c(){e&&z(e.$$.fragment),n=y()},l(l){e&&W(e.$$.fragment,l),n=y()},m(l,s){e&&B(e,l,s),f(l,n,s),i=!0},p(l,s){const c=s&64?he(t,[pe(l[18])]):{};if(s&8388704&&(c.$$scope={dirty:s,ctx:l}),r!==(r=l[5].unorderedlistitem||l[5].listitem)){if(e){R();const m=e;h(m.$$.fragment,1,0,()=>{$(m,1)}),M()}r?(e=K(r,a(l)),z(e.$$.fragment),d(e.$$.fragment,1),B(e,n.parentNode,n)):e=null}else r&&e.$set(c)},i(l){i||(e&&d(e.$$.fragment,l),i=!0)},o(l){e&&h(e.$$.fragment,l),i=!1},d(l){l&&u(n),e&&$(e,l)}}}function Jt(o){let e,n,i=o[6].items,t=[];for(let a=0;a<i.length;a+=1)t[a]=He(qe(o,i,a));const r=a=>h(t[a],1,1,()=>{t[a]=null});return{c(){for(let a=0;a<t.length;a+=1)t[a].c();e=y()},l(a){for(let l=0;l<t.length;l+=1)t[l].l(a);e=y()},m(a,l){for(let s=0;s<t.length;s+=1)t[s].m(a,l);f(a,e,l),n=!0},p(a,l){if(l&96){i=a[6].items;let s;for(s=0;s<i.length;s+=1){const c=qe(a,i,s);t[s]?(t[s].p(c,l),d(t[s],1)):(t[s]=He(c),t[s].c(),d(t[s],1),t[s].m(e.parentNode,e))}for(R(),s=i.length;s<t.length;s+=1)r(s);M()}},i(a){if(!n){for(let l=0;l<i.length;l+=1)d(t[l]);n=!0}},o(a){t=t.filter(Boolean);for(let l=0;l<t.length;l+=1)h(t[l]);n=!1},d(a){oe(t,a),a&&u(e)}}}function Zt(o){let e,n,i;return e=new ce({props:{tokens:o[18].tokens,renderers:o[5]}}),{c(){z(e.$$.fragment),n=X()},l(t){W(e.$$.fragment,t),n=ee(t)},m(t,r){B(e,t,r),f(t,n,r),i=!0},p(t,r){const a={};r&64&&(a.tokens=t[18].tokens),r&32&&(a.renderers=t[5]),e.$set(a)},i(t){i||(d(e.$$.fragment,t),i=!0)},o(t){h(e.$$.fragment,t),i=!1},d(t){$(e,t),t&&u(n)}}}function Ve(o){let e,n,i;const t=[o[18]];var r=o[5].orderedlistitem||o[5].listitem;function a(l){let s={$$slots:{default:[Zt]},$$scope:{ctx:l}};for(let c=0;c<t.length;c+=1)s=le(s,t[c]);return{props:s}}return r&&(e=K(r,a(o))),{c(){e&&z(e.$$.fragment),n=y()},l(l){e&&W(e.$$.fragment,l),n=y()},m(l,s){e&&B(e,l,s),f(l,n,s),i=!0},p(l,s){const c=s&64?he(t,[pe(l[18])]):{};if(s&8388704&&(c.$$scope={dirty:s,ctx:l}),r!==(r=l[5].orderedlistitem||l[5].listitem)){if(e){R();const m=e;h(m.$$.fragment,1,0,()=>{$(m,1)}),M()}r?(e=K(r,a(l)),z(e.$$.fragment),d(e.$$.fragment,1),B(e,n.parentNode,n)):e=null}else r&&e.$set(c)},i(l){i||(e&&d(e.$$.fragment,l),i=!0)},o(l){e&&h(e.$$.fragment,l),i=!1},d(l){l&&u(n),e&&$(e,l)}}}function Qt(o){let e,n,i=o[6].items,t=[];for(let a=0;a<i.length;a+=1)t[a]=Ve(We(o,i,a));const r=a=>h(t[a],1,1,()=>{t[a]=null});return{c(){for(let a=0;a<t.length;a+=1)t[a].c();e=y()},l(a){for(let l=0;l<t.length;l+=1)t[l].l(a);e=y()},m(a,l){for(let s=0;s<t.length;s+=1)t[s].m(a,l);f(a,e,l),n=!0},p(a,l){if(l&96){i=a[6].items;let s;for(s=0;s<i.length;s+=1){const c=We(a,i,s);t[s]?(t[s].p(c,l),d(t[s],1)):(t[s]=Ve(c),t[s].c(),d(t[s],1),t[s].m(e.parentNode,e))}for(R(),s=i.length;s<t.length;s+=1)r(s);M()}},i(a){if(!n){for(let l=0;l<i.length;l+=1)d(t[l]);n=!0}},o(a){t=t.filter(Boolean);for(let l=0;l<t.length;l+=1)h(t[l]);n=!1},d(a){oe(t,a),a&&u(e)}}}function Yt(o){let e,n,i;return e=new ce({props:{tokens:o[16].tokens,renderers:o[5]}}),{c(){z(e.$$.fragment),n=X()},l(t){W(e.$$.fragment,t),n=ee(t)},m(t,r){B(e,t,r),f(t,n,r),i=!0},p(t,r){const a={};r&4&&(a.tokens=t[16].tokens),r&32&&(a.renderers=t[5]),e.$set(a)},i(t){i||(d(e.$$.fragment,t),i=!0)},o(t){h(e.$$.fragment,t),i=!1},d(t){$(e,t),t&&u(n)}}}function Ue(o){let e,n,i;var t=o[5].tablecell;function r(a){return{props:{header:!0,align:a[6].align[a[15]]||"center",$$slots:{default:[Yt]},$$scope:{ctx:a}}}}return t&&(e=K(t,r(o))),{c(){e&&z(e.$$.fragment),n=y()},l(a){e&&W(e.$$.fragment,a),n=y()},m(a,l){e&&B(e,a,l),f(a,n,l),i=!0},p(a,l){const s={};if(l&64&&(s.align=a[6].align[a[15]]||"center"),l&8388644&&(s.$$scope={dirty:l,ctx:a}),t!==(t=a[5].tablecell)){if(e){R();const c=e;h(c.$$.fragment,1,0,()=>{$(c,1)}),M()}t?(e=K(t,r(a)),z(e.$$.fragment),d(e.$$.fragment,1),B(e,n.parentNode,n)):e=null}else t&&e.$set(s)},i(a){i||(e&&d(e.$$.fragment,a),i=!0)},o(a){e&&h(e.$$.fragment,a),i=!1},d(a){a&&u(n),e&&$(e,a)}}}function Xt(o){let e,n,i=o[2],t=[];for(let a=0;a<i.length;a+=1)t[a]=Ue(je(o,i,a));const r=a=>h(t[a],1,1,()=>{t[a]=null});return{c(){for(let a=0;a<t.length;a+=1)t[a].c();e=y()},l(a){for(let l=0;l<t.length;l+=1)t[l].l(a);e=y()},m(a,l){for(let s=0;s<t.length;s+=1)t[s].m(a,l);f(a,e,l),n=!0},p(a,l){if(l&100){i=a[2];let s;for(s=0;s<i.length;s+=1){const c=je(a,i,s);t[s]?(t[s].p(c,l),d(t[s],1)):(t[s]=Ue(c),t[s].c(),d(t[s],1),t[s].m(e.parentNode,e))}for(R(),s=i.length;s<t.length;s+=1)r(s);M()}},i(a){if(!n){for(let l=0;l<i.length;l+=1)d(t[l]);n=!0}},o(a){t=t.filter(Boolean);for(let l=0;l<t.length;l+=1)h(t[l]);n=!1},d(a){oe(t,a),a&&u(e)}}}function en(o){let e,n,i;var t=o[5].tablerow;function r(a){return{props:{$$slots:{default:[Xt]},$$scope:{ctx:a}}}}return t&&(e=K(t,r(o))),{c(){e&&z(e.$$.fragment),n=y()},l(a){e&&W(e.$$.fragment,a),n=y()},m(a,l){e&&B(e,a,l),f(a,n,l),i=!0},p(a,l){const s={};if(l&8388708&&(s.$$scope={dirty:l,ctx:a}),t!==(t=a[5].tablerow)){if(e){R();const c=e;h(c.$$.fragment,1,0,()=>{$(c,1)}),M()}t?(e=K(t,r(a)),z(e.$$.fragment),d(e.$$.fragment,1),B(e,n.parentNode,n)):e=null}else t&&e.$set(s)},i(a){i||(e&&d(e.$$.fragment,a),i=!0)},o(a){e&&h(e.$$.fragment,a),i=!1},d(a){a&&u(n),e&&$(e,a)}}}function tn(o){let e,n;return e=new ce({props:{tokens:o[13].tokens,renderers:o[5]}}),{c(){z(e.$$.fragment)},l(i){W(e.$$.fragment,i)},m(i,t){B(e,i,t),n=!0},p(i,t){const r={};t&8&&(r.tokens=i[13].tokens),t&32&&(r.renderers=i[5]),e.$set(r)},i(i){n||(d(e.$$.fragment,i),n=!0)},o(i){h(e.$$.fragment,i),n=!1},d(i){$(e,i)}}}function Je(o){let e,n,i;var t=o[5].tablecell;function r(a){return{props:{header:!1,align:a[6].align[a[15]]||"center",$$slots:{default:[tn]},$$scope:{ctx:a}}}}return t&&(e=K(t,r(o))),{c(){e&&z(e.$$.fragment),n=y()},l(a){e&&W(e.$$.fragment,a),n=y()},m(a,l){e&&B(e,a,l),f(a,n,l),i=!0},p(a,l){const s={};if(l&64&&(s.align=a[6].align[a[15]]||"center"),l&8388648&&(s.$$scope={dirty:l,ctx:a}),t!==(t=a[5].tablecell)){if(e){R();const c=e;h(c.$$.fragment,1,0,()=>{$(c,1)}),M()}t?(e=K(t,r(a)),z(e.$$.fragment),d(e.$$.fragment,1),B(e,n.parentNode,n)):e=null}else t&&e.$set(s)},i(a){i||(e&&d(e.$$.fragment,a),i=!0)},o(a){e&&h(e.$$.fragment,a),i=!1},d(a){a&&u(n),e&&$(e,a)}}}function nn(o){let e,n,i=o[10],t=[];for(let a=0;a<i.length;a+=1)t[a]=Je(Le(o,i,a));const r=a=>h(t[a],1,1,()=>{t[a]=null});return{c(){for(let a=0;a<t.length;a+=1)t[a].c();e=X()},l(a){for(let l=0;l<t.length;l+=1)t[l].l(a);e=ee(a)},m(a,l){for(let s=0;s<t.length;s+=1)t[s].m(a,l);f(a,e,l),n=!0},p(a,l){if(l&104){i=a[10];let s;for(s=0;s<i.length;s+=1){const c=Le(a,i,s);t[s]?(t[s].p(c,l),d(t[s],1)):(t[s]=Je(c),t[s].c(),d(t[s],1),t[s].m(e.parentNode,e))}for(R(),s=i.length;s<t.length;s+=1)r(s);M()}},i(a){if(!n){for(let l=0;l<i.length;l+=1)d(t[l]);n=!0}},o(a){t=t.filter(Boolean);for(let l=0;l<t.length;l+=1)h(t[l]);n=!1},d(a){oe(t,a),a&&u(e)}}}function Ze(o){let e,n,i;var t=o[5].tablerow;function r(a){return{props:{$$slots:{default:[nn]},$$scope:{ctx:a}}}}return t&&(e=K(t,r(o))),{c(){e&&z(e.$$.fragment),n=y()},l(a){e&&W(e.$$.fragment,a),n=y()},m(a,l){e&&B(e,a,l),f(a,n,l),i=!0},p(a,l){const s={};if(l&8388712&&(s.$$scope={dirty:l,ctx:a}),t!==(t=a[5].tablerow)){if(e){R();const c=e;h(c.$$.fragment,1,0,()=>{$(c,1)}),M()}t?(e=K(t,r(a)),z(e.$$.fragment),d(e.$$.fragment,1),B(e,n.parentNode,n)):e=null}else t&&e.$set(s)},i(a){i||(e&&d(e.$$.fragment,a),i=!0)},o(a){e&&h(e.$$.fragment,a),i=!1},d(a){a&&u(n),e&&$(e,a)}}}function rn(o){let e,n,i=o[3],t=[];for(let a=0;a<i.length;a+=1)t[a]=Ze(Ke(o,i,a));const r=a=>h(t[a],1,1,()=>{t[a]=null});return{c(){for(let a=0;a<t.length;a+=1)t[a].c();e=y()},l(a){for(let l=0;l<t.length;l+=1)t[l].l(a);e=y()},m(a,l){for(let s=0;s<t.length;s+=1)t[s].m(a,l);f(a,e,l),n=!0},p(a,l){if(l&104){i=a[3];let s;for(s=0;s<i.length;s+=1){const c=Ke(a,i,s);t[s]?(t[s].p(c,l),d(t[s],1)):(t[s]=Ze(c),t[s].c(),d(t[s],1),t[s].m(e.parentNode,e))}for(R(),s=i.length;s<t.length;s+=1)r(s);M()}},i(a){if(!n){for(let l=0;l<i.length;l+=1)d(t[l]);n=!0}},o(a){t=t.filter(Boolean);for(let l=0;l<t.length;l+=1)h(t[l]);n=!1},d(a){oe(t,a),a&&u(e)}}}function an(o){let e,n,i,t,r;var a=o[5].tablehead;function l(m){return{props:{$$slots:{default:[en]},$$scope:{ctx:m}}}}a&&(e=K(a,l(o)));var s=o[5].tablebody;function c(m){return{props:{$$slots:{default:[rn]},$$scope:{ctx:m}}}}return s&&(i=K(s,c(o))),{c(){e&&z(e.$$.fragment),n=X(),i&&z(i.$$.fragment),t=y()},l(m){e&&W(e.$$.fragment,m),n=ee(m),i&&W(i.$$.fragment,m),t=y()},m(m,p){e&&B(e,m,p),f(m,n,p),i&&B(i,m,p),f(m,t,p),r=!0},p(m,p){const w={};if(p&8388708&&(w.$$scope={dirty:p,ctx:m}),a!==(a=m[5].tablehead)){if(e){R();const T=e;h(T.$$.fragment,1,0,()=>{$(T,1)}),M()}a?(e=K(a,l(m)),z(e.$$.fragment),d(e.$$.fragment,1),B(e,n.parentNode,n)):e=null}else a&&e.$set(w);const g={};if(p&8388712&&(g.$$scope={dirty:p,ctx:m}),s!==(s=m[5].tablebody)){if(i){R();const T=i;h(T.$$.fragment,1,0,()=>{$(T,1)}),M()}s?(i=K(s,c(m)),z(i.$$.fragment),d(i.$$.fragment,1),B(i,t.parentNode,t)):i=null}else s&&i.$set(g)},i(m){r||(e&&d(e.$$.fragment,m),i&&d(i.$$.fragment,m),r=!0)},o(m){e&&h(e.$$.fragment,m),i&&h(i.$$.fragment,m),r=!1},d(m){e&&$(e,m),m&&u(n),m&&u(t),i&&$(i,m)}}}function Qe(o){let e,n;const i=[o[7],{renderers:o[5]}];let t={};for(let r=0;r<i.length;r+=1)t=le(t,i[r]);return e=new ce({props:t}),{c(){z(e.$$.fragment)},l(r){W(e.$$.fragment,r)},m(r,a){B(e,r,a),n=!0},p(r,a){const l=a&34?he(i,[a&2&&pe(r[7]),a&32&&{renderers:r[5]}]):{};e.$set(l)},i(r){n||(d(e.$$.fragment,r),n=!0)},o(r){h(e.$$.fragment,r),n=!1},d(r){$(e,r)}}}function on(o){let e,n,i,t;const r=[Gt,Mt],a=[];function l(s,c){return s[0]?s[5][s[0]]?1:-1:0}return~(e=l(o))&&(n=a[e]=r[e](o)),{c(){n&&n.c(),i=y()},l(s){n&&n.l(s),i=y()},m(s,c){~e&&a[e].m(s,c),f(s,i,c),t=!0},p(s,[c]){let m=e;e=l(s),e===m?~e&&a[e].p(s,c):(n&&(R(),h(a[m],1,1,()=>{a[m]=null}),M()),~e?(n=a[e],n?n.p(s,c):(n=a[e]=r[e](s),n.c()),d(n,1),n.m(i.parentNode,i)):n=null)},i(s){t||(d(n),t=!0)},o(s){h(n),t=!1},d(s){~e&&a[e].d(s),s&&u(i)}}}function sn(o,e,n){const i=["type","tokens","header","rows","ordered","renderers"];let t=Ce(e,i),{type:r=void 0}=e,{tokens:a=void 0}=e,{header:l=void 0}=e,{rows:s=void 0}=e,{ordered:c=!1}=e,{renderers:m}=e;return Rt(),o.$$set=p=>{e=le(le({},e),Pt(p)),n(6,t=Ce(e,i)),"type"in p&&n(0,r=p.type),"tokens"in p&&n(1,a=p.tokens),"header"in p&&n(2,l=p.header),"rows"in p&&n(3,s=p.rows),"ordered"in p&&n(4,c=p.ordered),"renderers"in p&&n(5,m=p.renderers)},[r,a,l,s,c,m,t]}let ce=class extends E{constructor(e){super(),C(this,e,sn,on,N,{type:0,tokens:1,header:2,rows:3,ordered:4,renderers:5})}};function pt(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}let fe=pt();function ln(o){fe=o}const ft=/[&<>"']/,cn=new RegExp(ft.source,"g"),gt=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,mn=new RegExp(gt.source,"g"),un={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ye=o=>un[o];function Z(o,e){if(e){if(ft.test(o))return o.replace(cn,Ye)}else if(gt.test(o))return o.replace(mn,Ye);return o}const dn=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function St(o){return o.replace(dn,(e,n)=>(n=n.toLowerCase(),n==="colon"?":":n.charAt(0)==="#"?n.charAt(1)==="x"?String.fromCharCode(parseInt(n.substring(2),16)):String.fromCharCode(+n.substring(1)):""))}const hn=/(^|[^\[])\^/g;function q(o,e){o=typeof o=="string"?o:o.source,e=e||"";const n={replace:(i,t)=>(t=t.source||t,t=t.replace(hn,"$1"),o=o.replace(i,t),n),getRegex:()=>new RegExp(o,e)};return n}const pn=/[^\w:]/g,fn=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function Xe(o,e,n){if(o){let i;try{i=decodeURIComponent(St(n)).replace(pn,"").toLowerCase()}catch{return null}if(i.indexOf("javascript:")===0||i.indexOf("vbscript:")===0||i.indexOf("data:")===0)return null}e&&!fn.test(n)&&(n=wn(e,n));try{n=encodeURI(n).replace(/%25/g,"%")}catch{return null}return n}const ke={},gn=/^[^:]+:\/*[^/]*$/,Sn=/^([^:]+:)[\s\S]*$/,vn=/^([^:]+:\/*[^/]*)[\s\S]*$/;function wn(o,e){ke[" "+o]||(gn.test(o)?ke[" "+o]=o+"/":ke[" "+o]=Te(o,"/",!0)),o=ke[" "+o];const n=o.indexOf(":")===-1;return e.substring(0,2)==="//"?n?e:o.replace(Sn,"$1")+e:e.charAt(0)==="/"?n?e:o.replace(vn,"$1")+e:o+e}const Pe={exec:function(){}};function ne(o){let e=1,n,i;for(;e<arguments.length;e++){n=arguments[e];for(i in n)Object.prototype.hasOwnProperty.call(n,i)&&(o[i]=n[i])}return o}function et(o,e){const n=o.replace(/\|/g,(r,a,l)=>{let s=!1,c=a;for(;--c>=0&&l[c]==="\\";)s=!s;return s?"|":" |"}),i=n.split(/ \|/);let t=0;if(i[0].trim()||i.shift(),i.length>0&&!i[i.length-1].trim()&&i.pop(),i.length>e)i.splice(e);else for(;i.length<e;)i.push("");for(;t<i.length;t++)i[t]=i[t].trim().replace(/\\\|/g,"|");return i}function Te(o,e,n){const i=o.length;if(i===0)return"";let t=0;for(;t<i;){const r=o.charAt(i-t-1);if(r===e&&!n)t++;else if(r!==e&&n)t++;else break}return o.slice(0,i-t)}function bn(o,e){if(o.indexOf(e[1])===-1)return-1;const n=o.length;let i=0,t=0;for(;t<n;t++)if(o[t]==="\\")t++;else if(o[t]===e[0])i++;else if(o[t]===e[1]&&(i--,i<0))return t;return-1}function vt(o){o&&o.sanitize&&!o.silent&&console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options")}function tt(o,e){if(e<1)return"";let n="";for(;e>1;)e&1&&(n+=o),e>>=1,o+=o;return n+o}function nt(o,e,n,i){const t=e.href,r=e.title?Z(e.title):null,a=o[1].replace(/\\([\[\]])/g,"$1");if(o[0].charAt(0)!=="!"){i.state.inLink=!0;const l={type:"link",raw:n,href:t,title:r,text:a,tokens:i.inlineTokens(a)};return i.state.inLink=!1,l}return{type:"image",raw:n,href:t,title:r,text:Z(a)}}function yn(o,e){const n=o.match(/^(\s+)(?:```)/);if(n===null)return e;const i=n[1];return e.split(`
`).map(t=>{const r=t.match(/^\s+/);if(r===null)return t;const[a]=r;return a.length>=i.length?t.slice(i.length):t}).join(`
`)}class ze{constructor(e){this.options=e||fe}space(e){const n=this.rules.block.newline.exec(e);if(n&&n[0].length>0)return{type:"space",raw:n[0]}}code(e){const n=this.rules.block.code.exec(e);if(n){const i=n[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:n[0],codeBlockStyle:"indented",text:this.options.pedantic?i:Te(i,`
`)}}}fences(e){const n=this.rules.block.fences.exec(e);if(n){const i=n[0],t=yn(i,n[3]||"");return{type:"code",raw:i,lang:n[2]?n[2].trim().replace(this.rules.inline._escapes,"$1"):n[2],text:t}}}heading(e){const n=this.rules.block.heading.exec(e);if(n){let i=n[2].trim();if(/#$/.test(i)){const t=Te(i,"#");(this.options.pedantic||!t||/ $/.test(t))&&(i=t.trim())}return{type:"heading",raw:n[0],depth:n[1].length,text:i,tokens:this.lexer.inline(i)}}}hr(e){const n=this.rules.block.hr.exec(e);if(n)return{type:"hr",raw:n[0]}}blockquote(e){const n=this.rules.block.blockquote.exec(e);if(n){const i=n[0].replace(/^ *>[ \t]?/gm,""),t=this.lexer.state.top;this.lexer.state.top=!0;const r=this.lexer.blockTokens(i);return this.lexer.state.top=t,{type:"blockquote",raw:n[0],tokens:r,text:i}}}list(e){let n=this.rules.block.list.exec(e);if(n){let i,t,r,a,l,s,c,m,p,w,g,T,_=n[1].trim();const x=_.length>1,I={type:"list",raw:"",ordered:x,start:x?+_.slice(0,-1):"",loose:!1,items:[]};_=x?`\\d{1,9}\\${_.slice(-1)}`:`\\${_}`,this.options.pedantic&&(_=x?_:"[*+-]");const G=new RegExp(`^( {0,3}${_})((?:[	 ][^\\n]*)?(?:\\n|$))`);for(;e&&(T=!1,!(!(n=G.exec(e))||this.rules.block.hr.test(e)));){if(i=n[0],e=e.substring(i.length),m=n[2].split(`
`,1)[0].replace(/^\t+/,te=>" ".repeat(3*te.length)),p=e.split(`
`,1)[0],this.options.pedantic?(a=2,g=m.trimLeft()):(a=n[2].search(/[^ ]/),a=a>4?1:a,g=m.slice(a),a+=n[1].length),s=!1,!m&&/^ *$/.test(p)&&(i+=p+`
`,e=e.substring(p.length+1),T=!0),!T){const te=new RegExp(`^ {0,${Math.min(3,a-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),Q=new RegExp(`^ {0,${Math.min(3,a-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),Y=new RegExp(`^ {0,${Math.min(3,a-1)}}(?:\`\`\`|~~~)`),se=new RegExp(`^ {0,${Math.min(3,a-1)}}#`);for(;e&&(w=e.split(`
`,1)[0],p=w,this.options.pedantic&&(p=p.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  ")),!(Y.test(p)||se.test(p)||te.test(p)||Q.test(e)));){if(p.search(/[^ ]/)>=a||!p.trim())g+=`
`+p.slice(a);else{if(s||m.search(/[^ ]/)>=4||Y.test(m)||se.test(m)||Q.test(m))break;g+=`
`+p}!s&&!p.trim()&&(s=!0),i+=w+`
`,e=e.substring(w.length+1),m=p.slice(a)}}I.loose||(c?I.loose=!0:/\n *\n *$/.test(i)&&(c=!0)),this.options.gfm&&(t=/^\[[ xX]\] /.exec(g),t&&(r=t[0]!=="[ ] ",g=g.replace(/^\[[ xX]\] +/,""))),I.items.push({type:"list_item",raw:i,task:!!t,checked:r,loose:!1,text:g}),I.raw+=i}I.items[I.items.length-1].raw=i.trimRight(),I.items[I.items.length-1].text=g.trimRight(),I.raw=I.raw.trimRight();const J=I.items.length;for(l=0;l<J;l++)if(this.lexer.state.top=!1,I.items[l].tokens=this.lexer.blockTokens(I.items[l].text,[]),!I.loose){const te=I.items[l].tokens.filter(Y=>Y.type==="space"),Q=te.length>0&&te.some(Y=>/\n.*\n/.test(Y.raw));I.loose=Q}if(I.loose)for(l=0;l<J;l++)I.items[l].loose=!0;return I}}html(e){const n=this.rules.block.html.exec(e);if(n){const i={type:"html",raw:n[0],pre:!this.options.sanitizer&&(n[1]==="pre"||n[1]==="script"||n[1]==="style"),text:n[0]};if(this.options.sanitize){const t=this.options.sanitizer?this.options.sanitizer(n[0]):Z(n[0]);i.type="paragraph",i.text=t,i.tokens=this.lexer.inline(t)}return i}}def(e){const n=this.rules.block.def.exec(e);if(n){const i=n[1].toLowerCase().replace(/\s+/g," "),t=n[2]?n[2].replace(/^<(.*)>$/,"$1").replace(this.rules.inline._escapes,"$1"):"",r=n[3]?n[3].substring(1,n[3].length-1).replace(this.rules.inline._escapes,"$1"):n[3];return{type:"def",tag:i,raw:n[0],href:t,title:r}}}table(e){const n=this.rules.block.table.exec(e);if(n){const i={type:"table",header:et(n[1]).map(t=>({text:t})),align:n[2].replace(/^ *|\| *$/g,"").split(/ *\| */),rows:n[3]&&n[3].trim()?n[3].replace(/\n[ \t]*$/,"").split(`
...
`+i.raw,t.text+=`
`+i.text,this.inlineQueue.pop(),this.inlineQueue[this.inlineQueue.length-1].src=t.text):n.push(i);continue}if(e){const l="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(l);break}else throw new Error(l)}}return this.state.top=!0,n}inline(e,n=[]){return this.inlineQueue.push({src:e,tokens:n}),n}inlineTokens(e,n=[]){let i,t,r,a=e,l,s,c;if(this.tokens.links){const m=Object.keys(this.tokens.links);if(m.length>0)for(;(l=this.tokenizer.rules.inline.reflinkSearch.exec(a))!=null;)m.includes(l[0].slice(l[0].lastIndexOf("[")+1,-1))&&(a=a.slice(0,l.index)+"["+tt("a",l[0].length-2)+"]"+a.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(l=this.tokenizer.rules.inline.blockSkip.exec(a))!=null;)a=a.slice(0,l.index)+"["+tt("a",l[0].length-2)+"]"+a.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;(l=this.tokenizer.rules.inline.escapedEmSt.exec(a))!=null;)a=a.slice(0,l.index+l[0].length-2)+"++"+a.slice(this.tokenizer.rules.inline.escapedEmSt.lastIndex),this.tokenizer.rules.inline.escapedEmSt.lastIndex--;for(;e;)if(s||(c=""),s=!1,!(this.options.extensions&&this.options.extensions.inline&&this.options.extensions.inline.some(m=>(i=m.call({lexer:this},e,n))?(e=e.substring(i.raw.length),n.push(i),!0):!1))){if(i=this.tokenizer.escape(e)){e=e.substring(i.raw.length),n.push(i);continue}if(i=this.tokenizer.tag(e)){e=e.substring(i.raw.length),t=n[n.length-1],t&&i.type==="text"&&t.type==="text"?(t.raw+=i.raw,t.text+=i.text):n.push(i);continue}if(i=this.tokenizer.link(e)){e=e.substring(i.raw.length),n.push(i);continue}if(i=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(i.raw.length),t=n[n.length-1],t&&i.type==="text"&&t.type==="text"?(t.raw+=i.raw,t.text+=i.text):n.push(i);continue}if(i=this.tokenizer.emStrong(e,a,c)){e=e.substring(i.raw.length),n.push(i);continue}if(i=this.tokenizer.codespan(e)){e=e.substring(i.raw.length),n.push(i);continue}if(i=this.tokenizer.br(e)){e=e.substring(i.raw.length),n.push(i);continue}if(i=this.tokenizer.del(e)){e=e.substring(i.raw.length),n.push(i);continue}if(i=this.tokenizer.autolink(e,it)){e=e.substring(i.raw.length),n.push(i);continue}if(!this.state.inLink&&(i=this.tokenizer.url(e,it))){e=e.substring(i.raw.length),n.push(i);continue}if(r=e,this.options.extensions&&this.options.extensions.startInline){let m=1/0;const p=e.slice(1);let w;this.options.extensions.startInline.forEach(function(g){w=g.call({lexer:this},p),typeof w=="number"&&w>=0&&(m=Math.min(m,w))}),m<1/0&&m>=0&&(r=e.substring(0,m+1))}if(i=this.tokenizer.inlineText(r,kn)){e=e.substring(i.raw.length),i.raw.slice(-1)!=="_"&&(c=i.raw.slice(-1)),s=!0,t=n[n.length-1],t&&t.type==="text"?(t.raw+=i.raw,t.text+=i.text):n.push(i);continue}if(e){const m="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(m);break}else throw new Error(m)}}return n}}class Be{constructor(e){this.options=e||fe}code(e,n,i){const t=(n||"").match(/\S*/)[0];if(this.options.highlight){const r=this.options.highlight(e,t);r!=null&&r!==e&&(i=!0,e=r)}return e=e.replace(/\n$/,"")+`
...
`}strong(e){return`<strong>${e}</strong>`}em(e){return`<em>${e}</em>`}codespan(e){return`<code>${e}</code>`}br(){return this.options.xhtml?"<br/>":"<br>"}del(e){return`<del>${e}</del>`}link(e,n,i){if(e=Xe(this.options.sanitize,this.options.baseUrl,e),e===null)return i;let t='<a href="'+e+'"';return n&&(t+=' title="'+n+'"'),t+=">"+i+"</a>",t}image(e,n,i){if(e=Xe(this.options.sanitize,this.options.baseUrl,e),e===null)return i;let t=`<img src="${e}" alt="${i}"`;return n&&(t+=` title="${n}"`),t+=this.options.xhtml?"/>":">",t}text(e){return e}}class wt{strong(e){return e}em(e){return e}codespan(e){return e}del(e){return e}html(e){return e}text(e){return e}link(e,n,i){return""+i}image(e,n,i){return""+i}br(){return""}}class $e{constructor(){this.seen={}}serialize(e){return e.toLowerCase().trim().replace(/<[!\/a-z].*?>/ig,"").replace(/[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,./:;<=>?@[\]^`{|}~]/g,"").replace(/\s/g,"-")}getNextSafeSlug(e,n){let i=e,t=0;if(this.seen.hasOwnProperty(i)){t=this.seen[e];do t++,i=e+"-"+t;while(this.seen.hasOwnProperty(i))}return n||(this.seen[e]=t,this.seen[i]=0),i}slug(e,n={}){const i=this.serialize(e);return this.getNextSafeSlug(i,n.dryrun)}}class ie{constructor(e){this.options=e||fe,this.options.renderer=this.options.renderer||new Be,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new wt,this.slugger=new $e}static parse(e,n){return new ie(n).parse(e)}static parseInline(e,n){return new ie(n).parseInline(e)}parse(e,n=!0){let i="",t,r,a,l,s,c,m,p,w,g,T,_,x,I,G,J,te,Q,Y;const se=e.length;for(t=0;t<se;t++){if(g=e[t],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[g.type]&&(Y=this.options.extensions.renderers[g.type].call({parser:this},g),Y!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(g.type))){i+=Y||"";continue}switch(g.type){case"space":continue;case"hr":{i+=this.renderer.hr();continue}case"heading":{i+=this.renderer.heading(this.parseInline(g.tokens),g.depth,St(this.parseInline(g.tokens,this.textRenderer)),this.slugger);continue}case"code":{i+=this.renderer.code(g.text,g.lang,g.escaped);continue}case"table":{for(p="",m="",l=g.header.length,r=0;r<l;r++)m+=this.renderer.tablecell(this.parseInline(g.header[r].tokens),{header:!0,align:g.align[r]});for(p+=this.renderer.tablerow(m),w="",l=g.rows.length,r=0;r<l;r++){for(c=g.rows[r],m="",s=c.length,a=0;a<s;a++)m+=this.renderer.tablecell(this.parseInline(c[a].tokens),{header:!1,align:g.align[a]});w+=this.renderer.tablerow(m)}i+=this.renderer.table(p,w);continue}case"blockquote":{w=this.parse(g.tokens),i+=this.renderer.blockquote(w);continue}case"list":{for(T=g.ordered,_=g.start,x=g.loose,l=g.items.length,w="",r=0;r<l;r++)G=g.items[r],J=G.checked,te=G.task,I="",G.task&&(Q=this.renderer.checkbox(J),x?G.tokens.length>0&&G.tokens[0].type==="paragraph"?(G.tokens[0].text=Q+" "+G.tokens[0].text,G.tokens[0].tokens&&G.tokens[0].tokens.length>0&&G.tokens[0].tokens[0].type==="text"&&(G.tokens[0].tokens[0].text=Q+" "+G.tokens[0].tokens[0].text)):G.tokens.unshift({type:"text",text:Q}):I+=Q),I+=this.parse(G.tokens,x),w+=this.renderer.listitem(I,te,J);i+=this.renderer.list(w,T,_);continue}case"html":{i+=this.renderer.html(g.text);continue}case"paragraph":{i+=this.renderer.paragraph(this.parseInline(g.tokens));continue}case"text":{for(w=g.tokens?this.parseInline(g.tokens):g.text;t+1<se&&e[t+1].type==="text";)g=e[++t],w+=`
`+(g.tokens?this.parseInline(g.tokens):g.text);i+=n?this.renderer.paragraph(w):w;continue}default:{const we='Token with "'+g.type+'" type was not found.';if(this.options.silent){console.error(we);return}else throw new Error(we)}}}return i}parseInline(e,n){n=n||this.renderer;let i="",t,r,a;const l=e.length;for(t=0;t<l;t++){if(r=e[t],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[r.type]&&(a=this.options.extensions.renderers[r.type].call({parser:this},r),a!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(r.type))){i+=a||"";continue}switch(r.type){case"escape":{i+=n.text(r.text);break}case"html":{i+=n.html(r.text);break}case"link":{i+=n.link(r.href,r.title,this.parseInline(r.tokens,n));break}case"image":{i+=n.image(r.href,r.title,r.text);break}case"strong":{i+=n.strong(this.parseInline(r.tokens,n));break}case"em":{i+=n.em(this.parseInline(r.tokens,n));break}case"codespan":{i+=n.codespan(r.text);break}case"br":{i+=n.br();break}case"del":{i+=n.del(this.parseInline(r.tokens,n));break}case"text":{i+=n.text(r.text);break}default:{const s='Token with "'+r.type+'" type was not found.';if(this.options.silent){console.error(s);return}else throw new Error(s)}}}return i}}function P(o,e,n){if(typeof o>"u"||o===null)throw new Error("marked(): input parameter is undefined or null");if(typeof o!="string")throw new Error("marked(): input parameter is of type "+Object.prototype.toString.call(o)+", string expected");if(typeof e=="function"&&(n=e,e=null),e=ne({},P.defaults,e||{}),vt(e),n){const t=e.highlight;let r;try{r=re.lex(o,e)}catch(s){return n(s)}const a=function(s){let c;if(!s)try{e.walkTokens&&P.walkTokens(r,e.walkTokens),c=ie.parse(r,e)}catch(m){s=m}return e.highlight=t,s?n(s):n(null,c)};if(!t||t.length<3||(delete e.highlight,!r.length))return a();let l=0;P.walkTokens(r,function(s){s.type==="code"&&(l++,setTimeout(()=>{t(s.text,s.lang,function(c,m){if(c)return a(c);m!=null&&m!==s.text&&(s.text=m,s.escaped=!0),l--,l===0&&a()})},0))}),l===0&&a();return}function i(t){if(t.message+=`
Please report this to https://github.com/markedjs/marked.`,e.silent)return"<p>An error occurred:</p><pre>"+Z(t.message+"",!0)+"</pre>";throw t}try{const t=re.lex(o,e);if(e.walkTokens){if(e.async)return Promise.all(P.walkTokens(t,e.walkTokens)).then(()=>ie.parse(t,e)).catch(i);P.walkTokens(t,e.walkTokens)}return ie.parse(t,e)}catch(t){i(t)}}P.options=P.setOptions=function(o){return ne(P.defaults,o),ln(P.defaults),P};P.getDefaults=pt;P.defaults=fe;P.use=function(...o){const e=P.defaults.extensions||{renderers:{},childTokens:{}};o.forEach(n=>{const i=ne({},n);if(i.async=P.defaults.async||i.async,n.extensions&&(n.extensions.forEach(t=>{if(!t.name)throw new Error("extension name required");if(t.renderer){const r=e.renderers[t.name];r?e.renderers[t.name]=function(...a){let l=t.renderer.apply(this,a);return l===!1&&(l=r.apply(this,a)),l}:e.renderers[t.name]=t.renderer}if(t.tokenizer){if(!t.level||t.level!=="block"&&t.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");e[t.level]?e[t.level].unshift(t.tokenizer):e[t.level]=[t.tokenizer],t.start&&(t.level==="block"?e.startBlock?e.startBlock.push(t.start):e.startBlock=[t.start]:t.level==="inline"&&(e.startInline?e.startInline.push(t.start):e.startInline=[t.start]))}t.childTokens&&(e.childTokens[t.name]=t.childTokens)}),i.extensions=e),n.renderer){const t=P.defaults.renderer||new Be;for(const r in n.renderer){const a=t[r];t[r]=(...l)=>{let s=n.renderer[r].apply(t,l);return s===!1&&(s=a.apply(t,l)),s}}i.renderer=t}if(n.tokenizer){const t=P.defaults.tokenizer||new ze;for(const r in n.tokenizer){const a=t[r];t[r]=(...l)=>{let s=n.tokenizer[r].apply(t,l);return s===!1&&(s=a.apply(t,l)),s}}i.tokenizer=t}if(n.walkTokens){const t=P.defaults.walkTokens;i.walkTokens=function(r){let a=[];return a.push(n.walkTokens.call(this,r)),t&&(a=a.concat(t.call(this,r))),a}}P.setOptions(i)})};P.walkTokens=function(o,e){let n=[];for(const i of o)switch(n=n.concat(e.call(P,i)),i.type){case"table":{for(const t of i.header)n=n.concat(P.walkTokens(t.tokens,e));for(const t of i.rows)for(const r of t)n=n.concat(P.walkTokens(r.tokens,e));break}case"list":{n=n.concat(P.walkTokens(i.items,e));break}default:P.defaults.extensions&&P.defaults.extensions.childTokens&&P.defaults.extensions.childTokens[i.type]?P.defaults.extensions.childTokens[i.type].forEach(function(t){n=n.concat(P.walkTokens(i[t],e))}):i.tokens&&(n=n.concat(P.walkTokens(i.tokens,e)))}return n};P.parseInline=function(o,e){if(typeof o>"u"||o===null)throw new Error("marked.parseInline(): input parameter is undefined or null");if(typeof o!="string")throw new Error("marked.parseInline(): input parameter is of type "+Object.prototype.toString.call(o)+", string expected");e=ne({},P.defaults,e||{}),vt(e);try{const n=re.lexInline(o,e);return e.walkTokens&&P.walkTokens(n,e.walkTokens),ie.parseInline(n,e)}catch(n){if(n.message+=`
Please report this to https://github.com/markedjs/marked.`,e.silent)return"<p>An error occurred:</p><pre>"+Z(n.message+"",!0)+"</pre>";throw n}};P.Parser=ie;P.parser=ie.parse;P.Renderer=Be;P.TextRenderer=wt;P.Lexer=re;P.lexer=re.lex;P.Tokenizer=ze;P.Slugger=$e;P.parse=P;P.options;P.setOptions;P.use;P.walkTokens;P.parseInline;ie.parse;re.lex;const bt={};function Tn(o){let e;return{c(){e=ue(o[1])},l(n){e=de(n,o[1])},m(n,i){f(n,e,i)},p(n,i){i&2&&ve(e,n[1])},i:V,o:V,d(n){n&&u(e)}}}function _n(o){let e,n;const i=o[5].default,t=L(i,o,o[4],null);return{c(){e=A("h6"),t&&t.c(),this.h()},l(r){e=D(r,"H6",{id:!0});var a=O(e);t&&t.l(a),a.forEach(u),this.h()},h(){k(e,"id",o[2])},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,a){t&&t.p&&(!n||a&16)&&j(t,i,r,r[4],n?H(i,r[4],a,null):F(r[4]),null),(!n||a&4)&&k(e,"id",r[2])},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function Pn(o){let e,n;const i=o[5].default,t=L(i,o,o[4],null);return{c(){e=A("h5"),t&&t.c(),this.h()},l(r){e=D(r,"H5",{id:!0});var a=O(e);t&&t.l(a),a.forEach(u),this.h()},h(){k(e,"id",o[2])},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,a){t&&t.p&&(!n||a&16)&&j(t,i,r,r[4],n?H(i,r[4],a,null):F(r[4]),null),(!n||a&4)&&k(e,"id",r[2])},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function xn(o){let e,n;const i=o[5].default,t=L(i,o,o[4],null);return{c(){e=A("h4"),t&&t.c(),this.h()},l(r){e=D(r,"H4",{id:!0});var a=O(e);t&&t.l(a),a.forEach(u),this.h()},h(){k(e,"id",o[2])},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,a){t&&t.p&&(!n||a&16)&&j(t,i,r,r[4],n?H(i,r[4],a,null):F(r[4]),null),(!n||a&4)&&k(e,"id",r[2])},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function In(o){let e,n;const i=o[5].default,t=L(i,o,o[4],null);return{c(){e=A("h3"),t&&t.c(),this.h()},l(r){e=D(r,"H3",{id:!0});var a=O(e);t&&t.l(a),a.forEach(u),this.h()},h(){k(e,"id",o[2])},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,a){t&&t.p&&(!n||a&16)&&j(t,i,r,r[4],n?H(i,r[4],a,null):F(r[4]),null),(!n||a&4)&&k(e,"id",r[2])},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function An(o){let e,n;const i=o[5].default,t=L(i,o,o[4],null);return{c(){e=A("h2"),t&&t.c(),this.h()},l(r){e=D(r,"H2",{id:!0});var a=O(e);t&&t.l(a),a.forEach(u),this.h()},h(){k(e,"id",o[2])},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,a){t&&t.p&&(!n||a&16)&&j(t,i,r,r[4],n?H(i,r[4],a,null):F(r[4]),null),(!n||a&4)&&k(e,"id",r[2])},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function Dn(o){let e,n;const i=o[5].default,t=L(i,o,o[4],null);return{c(){e=A("h1"),t&&t.c(),this.h()},l(r){e=D(r,"H1",{id:!0});var a=O(e);t&&t.l(a),a.forEach(u),this.h()},h(){k(e,"id",o[2])},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,a){t&&t.p&&(!n||a&16)&&j(t,i,r,r[4],n?H(i,r[4],a,null):F(r[4]),null),(!n||a&4)&&k(e,"id",r[2])},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function zn(o){let e,n,i,t;const r=[Dn,An,In,xn,Pn,_n,Tn],a=[];function l(s,c){return s[0]===1?0:s[0]===2?1:s[0]===3?2:s[0]===4?3:s[0]===5?4:s[0]===6?5:6}return e=l(o),n=a[e]=r[e](o),{c(){n.c(),i=y()},l(s){n.l(s),i=y()},m(s,c){a[e].m(s,c),f(s,i,c),t=!0},p(s,[c]){let m=e;e=l(s),e===m?a[e].p(s,c):(R(),h(a[m],1,1,()=>{a[m]=null}),M(),n=a[e],n?n.p(s,c):(n=a[e]=r[e](s),n.c()),d(n,1),n.m(i.parentNode,i))},i(s){t||(d(n),t=!0)},o(s){h(n),t=!1},d(s){a[e].d(s),s&&u(i)}}}function Bn(o,e,n){let i,{$$slots:t={},$$scope:r}=e,{depth:a}=e,{raw:l}=e,{text:s}=e;const{slug:c,getOptions:m}=xt(bt),p=m();return o.$$set=w=>{"depth"in w&&n(0,a=w.depth),"raw"in w&&n(1,l=w.raw),"text"in w&&n(3,s=w.text),"$$scope"in w&&n(4,r=w.$$scope)},o.$$.update=()=>{o.$$.dirty&8&&n(2,i=p.headerIds?p.headerPrefix+c(s):void 0)},[a,l,i,s,r,t]}class $n extends E{constructor(e){super(),C(this,e,Bn,zn,N,{depth:0,raw:1,text:3})}}function On(o){let e,n;const i=o[1].default,t=L(i,o,o[0],null);return{c(){e=A("p"),t&&t.c()},l(r){e=D(r,"P",{});var a=O(e);t&&t.l(a),a.forEach(u)},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,[a]){t&&t.p&&(!n||a&1)&&j(t,i,r,r[0],n?H(i,r[0],a,null):F(r[0]),null)},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function En(o,e,n){let{$$slots:i={},$$scope:t}=e;return o.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class Cn extends E{constructor(e){super(),C(this,e,En,On,N,{})}}function Nn(o){let e;const n=o[3].default,i=L(n,o,o[2],null);return{c(){i&&i.c()},l(t){i&&i.l(t)},m(t,r){i&&i.m(t,r),e=!0},p(t,[r]){i&&i.p&&(!e||r&4)&&j(i,n,t,t[2],e?H(n,t[2],r,null):F(t[2]),null)},i(t){e||(d(i,t),e=!0)},o(t){h(i,t),e=!1},d(t){i&&i.d(t)}}}function Rn(o,e,n){let{$$slots:i={},$$scope:t}=e,{text:r}=e,{raw:a}=e;return o.$$set=l=>{"text"in l&&n(0,r=l.text),"raw"in l&&n(1,a=l.raw),"$$scope"in l&&n(2,t=l.$$scope)},[r,a,t,i]}class Mn extends E{constructor(e){super(),C(this,e,Rn,Nn,N,{text:0,raw:1})}}function Gn(o){let e,n;return{c(){e=A("img"),this.h()},l(i){e=D(i,"IMG",{src:!0,title:!0,alt:!0}),this.h()},h(){_e(e.src,n=o[0])||k(e,"src",n),k(e,"title",o[1]),k(e,"alt",o[2])},m(i,t){f(i,e,t)},p(i,[t]){t&1&&!_e(e.src,n=i[0])&&k(e,"src",n),t&2&&k(e,"title",i[1]),t&4&&k(e,"alt",i[2])},i:V,o:V,d(i){i&&u(e)}}}function qn(o,e,n){let{href:i=""}=e,{title:t=void 0}=e,{text:r=""}=e;return o.$$set=a=>{"href"in a&&n(0,i=a.href),"title"in a&&n(1,t=a.title),"text"in a&&n(2,r=a.text)},[i,t,r]}class Wn extends E{constructor(e){super(),C(this,e,qn,Gn,N,{href:0,title:1,text:2})}}function Kn(o){let e,n;const i=o[3].default,t=L(i,o,o[2],null);return{c(){e=A("a"),t&&t.c(),this.h()},l(r){e=D(r,"A",{href:!0,title:!0});var a=O(e);t&&t.l(a),a.forEach(u),this.h()},h(){k(e,"href",o[0]),k(e,"title",o[1])},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,[a]){t&&t.p&&(!n||a&4)&&j(t,i,r,r[2],n?H(i,r[2],a,null):F(r[2]),null),(!n||a&1)&&k(e,"href",r[0]),(!n||a&2)&&k(e,"title",r[1])},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function Ln(o,e,n){let{$$slots:i={},$$scope:t}=e,{href:r=""}=e,{title:a=void 0}=e;return o.$$set=l=>{"href"in l&&n(0,r=l.href),"title"in l&&n(1,a=l.title),"$$scope"in l&&n(2,t=l.$$scope)},[r,a,t,i]}class jn extends E{constructor(e){super(),C(this,e,Ln,Kn,N,{href:0,title:1})}}function Fn(o){let e,n;const i=o[1].default,t=L(i,o,o[0],null);return{c(){e=A("em"),t&&t.c()},l(r){e=D(r,"EM",{});var a=O(e);t&&t.l(a),a.forEach(u)},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,[a]){t&&t.p&&(!n||a&1)&&j(t,i,r,r[0],n?H(i,r[0],a,null):F(r[0]),null)},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function Hn(o,e,n){let{$$slots:i={},$$scope:t}=e;return o.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class Vn extends E{constructor(e){super(),C(this,e,Hn,Fn,N,{})}}function Un(o){let e,n;const i=o[1].default,t=L(i,o,o[0],null);return{c(){e=A("del"),t&&t.c()},l(r){e=D(r,"DEL",{});var a=O(e);t&&t.l(a),a.forEach(u)},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,[a]){t&&t.p&&(!n||a&1)&&j(t,i,r,r[0],n?H(i,r[0],a,null):F(r[0]),null)},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function Jn(o,e,n){let{$$slots:i={},$$scope:t}=e;return o.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class Zn extends E{constructor(e){super(),C(this,e,Jn,Un,N,{})}}function Qn(o){let e,n=o[0].replace(/`/g,"")+"",i;return{c(){e=A("code"),i=ue(n)},l(t){e=D(t,"CODE",{});var r=O(e);i=de(r,n),r.forEach(u)},m(t,r){f(t,e,r),ae(e,i)},p(t,[r]){r&1&&n!==(n=t[0].replace(/`/g,"")+"")&&ve(i,n)},i:V,o:V,d(t){t&&u(e)}}}function Yn(o,e,n){let{raw:i}=e;return o.$$set=t=>{"raw"in t&&n(0,i=t.raw)},[i]}class Xn extends E{constructor(e){super(),C(this,e,Yn,Qn,N,{raw:0})}}function ei(o){let e,n;const i=o[1].default,t=L(i,o,o[0],null);return{c(){e=A("strong"),t&&t.c()},l(r){e=D(r,"STRONG",{});var a=O(e);t&&t.l(a),a.forEach(u)},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,[a]){t&&t.p&&(!n||a&1)&&j(t,i,r,r[0],n?H(i,r[0],a,null):F(r[0]),null)},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function ti(o,e,n){let{$$slots:i={},$$scope:t}=e;return o.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class ni extends E{constructor(e){super(),C(this,e,ti,ei,N,{})}}function ii(o){let e,n;const i=o[1].default,t=L(i,o,o[0],null);return{c(){e=A("table"),t&&t.c()},l(r){e=D(r,"TABLE",{});var a=O(e);t&&t.l(a),a.forEach(u)},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,[a]){t&&t.p&&(!n||a&1)&&j(t,i,r,r[0],n?H(i,r[0],a,null):F(r[0]),null)},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function ri(o,e,n){let{$$slots:i={},$$scope:t}=e;return o.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class ai extends E{constructor(e){super(),C(this,e,ri,ii,N,{})}}function oi(o){let e,n;const i=o[1].default,t=L(i,o,o[0],null);return{c(){e=A("thead"),t&&t.c()},l(r){e=D(r,"THEAD",{});var a=O(e);t&&t.l(a),a.forEach(u)},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,[a]){t&&t.p&&(!n||a&1)&&j(t,i,r,r[0],n?H(i,r[0],a,null):F(r[0]),null)},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function si(o,e,n){let{$$slots:i={},$$scope:t}=e;return o.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class li extends E{constructor(e){super(),C(this,e,si,oi,N,{})}}function ci(o){let e,n;const i=o[1].default,t=L(i,o,o[0],null);return{c(){e=A("tbody"),t&&t.c()},l(r){e=D(r,"TBODY",{});var a=O(e);t&&t.l(a),a.forEach(u)},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,[a]){t&&t.p&&(!n||a&1)&&j(t,i,r,r[0],n?H(i,r[0],a,null):F(r[0]),null)},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function mi(o,e,n){let{$$slots:i={},$$scope:t}=e;return o.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class ui extends E{constructor(e){super(),C(this,e,mi,ci,N,{})}}function di(o){let e,n;const i=o[1].default,t=L(i,o,o[0],null);return{c(){e=A("tr"),t&&t.c()},l(r){e=D(r,"TR",{});var a=O(e);t&&t.l(a),a.forEach(u)},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,[a]){t&&t.p&&(!n||a&1)&&j(t,i,r,r[0],n?H(i,r[0],a,null):F(r[0]),null)},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function hi(o,e,n){let{$$slots:i={},$$scope:t}=e;return o.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class pi extends E{constructor(e){super(),C(this,e,hi,di,N,{})}}function fi(o){let e,n;const i=o[3].default,t=L(i,o,o[2],null);return{c(){e=A("td"),t&&t.c(),this.h()},l(r){e=D(r,"TD",{align:!0});var a=O(e);t&&t.l(a),a.forEach(u),this.h()},h(){k(e,"align",o[1])},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,a){t&&t.p&&(!n||a&4)&&j(t,i,r,r[2],n?H(i,r[2],a,null):F(r[2]),null),(!n||a&2)&&k(e,"align",r[1])},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function gi(o){let e,n;const i=o[3].default,t=L(i,o,o[2],null);return{c(){e=A("th"),t&&t.c(),this.h()},l(r){e=D(r,"TH",{align:!0});var a=O(e);t&&t.l(a),a.forEach(u),this.h()},h(){k(e,"align",o[1])},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,a){t&&t.p&&(!n||a&4)&&j(t,i,r,r[2],n?H(i,r[2],a,null):F(r[2]),null),(!n||a&2)&&k(e,"align",r[1])},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function Si(o){let e,n,i,t;const r=[gi,fi],a=[];function l(s,c){return s[0]?0:1}return e=l(o),n=a[e]=r[e](o),{c(){n.c(),i=y()},l(s){n.l(s),i=y()},m(s,c){a[e].m(s,c),f(s,i,c),t=!0},p(s,[c]){let m=e;e=l(s),e===m?a[e].p(s,c):(R(),h(a[m],1,1,()=>{a[m]=null}),M(),n=a[e],n?n.p(s,c):(n=a[e]=r[e](s),n.c()),d(n,1),n.m(i.parentNode,i))},i(s){t||(d(n),t=!0)},o(s){h(n),t=!1},d(s){a[e].d(s),s&&u(i)}}}function vi(o,e,n){let{$$slots:i={},$$scope:t}=e,{header:r}=e,{align:a}=e;return o.$$set=l=>{"header"in l&&n(0,r=l.header),"align"in l&&n(1,a=l.align),"$$scope"in l&&n(2,t=l.$$scope)},[r,a,t,i]}class wi extends E{constructor(e){super(),C(this,e,vi,Si,N,{header:0,align:1})}}function bi(o){let e,n;const i=o[3].default,t=L(i,o,o[2],null);return{c(){e=A("ul"),t&&t.c()},l(r){e=D(r,"UL",{});var a=O(e);t&&t.l(a),a.forEach(u)},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,a){t&&t.p&&(!n||a&4)&&j(t,i,r,r[2],n?H(i,r[2],a,null):F(r[2]),null)},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function yi(o){let e,n;const i=o[3].default,t=L(i,o,o[2],null);return{c(){e=A("ol"),t&&t.c(),this.h()},l(r){e=D(r,"OL",{start:!0});var a=O(e);t&&t.l(a),a.forEach(u),this.h()},h(){k(e,"start",o[1])},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,a){t&&t.p&&(!n||a&4)&&j(t,i,r,r[2],n?H(i,r[2],a,null):F(r[2]),null),(!n||a&2)&&k(e,"start",r[1])},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function ki(o){let e,n,i,t;const r=[yi,bi],a=[];function l(s,c){return s[0]?0:1}return e=l(o),n=a[e]=r[e](o),{c(){n.c(),i=y()},l(s){n.l(s),i=y()},m(s,c){a[e].m(s,c),f(s,i,c),t=!0},p(s,[c]){let m=e;e=l(s),e===m?a[e].p(s,c):(R(),h(a[m],1,1,()=>{a[m]=null}),M(),n=a[e],n?n.p(s,c):(n=a[e]=r[e](s),n.c()),d(n,1),n.m(i.parentNode,i))},i(s){t||(d(n),t=!0)},o(s){h(n),t=!1},d(s){a[e].d(s),s&&u(i)}}}function Ti(o,e,n){let{$$slots:i={},$$scope:t}=e,{ordered:r}=e,{start:a}=e;return o.$$set=l=>{"ordered"in l&&n(0,r=l.ordered),"start"in l&&n(1,a=l.start),"$$scope"in l&&n(2,t=l.$$scope)},[r,a,t,i]}class _i extends E{constructor(e){super(),C(this,e,Ti,ki,N,{ordered:0,start:1})}}function Pi(o){let e,n;const i=o[1].default,t=L(i,o,o[0],null);return{c(){e=A("li"),t&&t.c()},l(r){e=D(r,"LI",{});var a=O(e);t&&t.l(a),a.forEach(u)},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,[a]){t&&t.p&&(!n||a&1)&&j(t,i,r,r[0],n?H(i,r[0],a,null):F(r[0]),null)},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function xi(o,e,n){let{$$slots:i={},$$scope:t}=e;return o.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class Ii extends E{constructor(e){super(),C(this,e,xi,Pi,N,{})}}function Ai(o){let e;return{c(){e=A("hr")},l(n){e=D(n,"HR",{})},m(n,i){f(n,e,i)},p:V,i:V,o:V,d(n){n&&u(e)}}}class Di extends E{constructor(e){super(),C(this,e,null,Ai,N,{})}}function zi(o){let e,n;return{c(){e=new It(!1),n=y(),this.h()},l(i){e=At(i,!1),n=y(),this.h()},h(){e.a=n},m(i,t){e.m(o[0],i,t),f(i,n,t)},p(i,[t]){t&1&&e.p(i[0])},i:V,o:V,d(i){i&&u(n),i&&e.d()}}}function Bi(o,e,n){let{text:i}=e;return o.$$set=t=>{"text"in t&&n(0,i=t.text)},[i]}class $i extends E{constructor(e){super(),C(this,e,Bi,zi,N,{text:0})}}function Oi(o){let e,n;const i=o[1].default,t=L(i,o,o[0],null);return{c(){e=A("blockquote"),t&&t.c()},l(r){e=D(r,"BLOCKQUOTE",{});var a=O(e);t&&t.l(a),a.forEach(u)},m(r,a){f(r,e,a),t&&t.m(e,null),n=!0},p(r,[a]){t&&t.p&&(!n||a&1)&&j(t,i,r,r[0],n?H(i,r[0],a,null):F(r[0]),null)},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function Ei(o,e,n){let{$$slots:i={},$$scope:t}=e;return o.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class Ci extends E{constructor(e){super(),C(this,e,Ei,Oi,N,{})}}function Ni(o){let e,n,i;return{c(){e=A("pre"),n=A("code"),i=ue(o[1]),this.h()},l(t){e=D(t,"PRE",{class:!0});var r=O(e);n=D(r,"CODE",{});var a=O(n);i=de(a,o[1]),a.forEach(u),r.forEach(u),this.h()},h(){k(e,"class",o[0])},m(t,r){f(t,e,r),ae(e,n),ae(n,i)},p(t,[r]){r&2&&ve(i,t[1]),r&1&&k(e,"class",t[0])},i:V,o:V,d(t){t&&u(e)}}}function Ri(o,e,n){let{lang:i}=e,{text:t}=e;return o.$$set=r=>{"lang"in r&&n(0,i=r.lang),"text"in r&&n(1,t=r.text)},[i,t]}class Mi extends E{constructor(e){super(),C(this,e,Ri,Ni,N,{lang:0,text:1})}}function Gi(o){let e,n;const i=o[1].default,t=L(i,o,o[0],null);return{c(){e=A("br"),t&&t.c()},l(r){e=D(r,"BR",{}),t&&t.l(r)},m(r,a){f(r,e,a),t&&t.m(r,a),n=!0},p(r,[a]){t&&t.p&&(!n||a&1)&&j(t,i,r,r[0],n?H(i,r[0],a,null):F(r[0]),null)},i(r){n||(d(t,r),n=!0)},o(r){h(t,r),n=!1},d(r){r&&u(e),t&&t.d(r)}}}function qi(o,e,n){let{$$slots:i={},$$scope:t}=e;return o.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class Wi extends E{constructor(e){super(),C(this,e,qi,Gi,N,{})}}const Ki={heading:$n,paragraph:Cn,text:Mn,image:Wn,link:jn,em:Vn,strong:ni,codespan:Xn,del:Zn,table:ai,tablehead:li,tablebody:ui,tablerow:pi,tablecell:wi,list:_i,orderedlistitem:null,unorderedlistitem:null,listitem:Ii,hr:Di,html:$i,blockquote:Ci,code:Mi,br:Wi},Li={baseUrl:null,breaks:!1,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartLists:!1,smartypants:!1,tokenizer:null,xhtml:!1};function ji(o){let e,n;return e=new ce({props:{tokens:o[0],renderers:o[1]}}),{c(){z(e.$$.fragment)},l(i){W(e.$$.fragment,i)},m(i,t){B(e,i,t),n=!0},p(i,[t]){const r={};t&1&&(r.tokens=i[0]),t&2&&(r.renderers=i[1]),e.$set(r)},i(i){n||(d(e.$$.fragment,i),n=!0)},o(i){h(e.$$.fragment,i),n=!1},d(i){$(e,i)}}}function Fi(o,e,n){let i,t,r,a,{source:l=[]}=e,{renderers:s={}}=e,{options:c={}}=e,{isInline:m=!1}=e;const p=Dt();let w,g,T;return zt(bt,{slug:_=>t?t.slug(_):"",getOptions:()=>r}),dt(()=>{n(7,T=!0)}),o.$$set=_=>{"source"in _&&n(2,l=_.source),"renderers"in _&&n(3,s=_.renderers),"options"in _&&n(4,c=_.options),"isInline"in _&&n(5,m=_.isInline)},o.$$.update=()=>{o.$$.dirty&4&&n(8,i=Array.isArray(l)),o.$$.dirty&4&&(t=l?new $e:void 0),o.$$.dirty&16&&n(9,r={...Li,...c}),o.$$.dirty&869&&(i?n(0,w=l):(n(6,g=new re(r)),n(0,w=m?g.inlineTokens(l):g.lex(l)),p("parsed",{tokens:w}))),o.$$.dirty&8&&n(1,a={...Ki,...s}),o.$$.dirty&385&&T&&!i&&p("parsed",{tokens:w})},[w,a,l,s,c,m,g,T,i,r]}class Hi extends E{constructor(e){super(),C(this,e,Fi,ji,N,{source:2,renderers:3,options:4,isInline:5})}}function Vi(){const{subscribe:o,set:e,update:n}=Ot(new Set);return{subscribe:o,add:i=>n(t=>t.add(i)),reset:()=>e(new Set)}}const xe=Vi(),Ui=$t(xe,o=>Array.from(o).sort((e,n)=>e.localeCompare(n)));function Ji(o){let e,n;return{c(){e=A("img"),this.h()},l(i){e=D(i,"IMG",{src:!0,title:!0,alt:!0,class:!0}),this.h()},h(){_e(e.src,n=o[0].replace("../static",""))||k(e,"src",n),k(e,"title",o[1]),k(e,"alt",o[2]),k(e,"class","svelte-1gl2z3f")},m(i,t){f(i,e,t)},p(i,[t]){t&1&&!_e(e.src,n=i[0].replace("../static",""))&&k(e,"src",n),t&2&&k(e,"title",i[1]),t&4&&k(e,"alt",i[2])},i:V,o:V,d(i){i&&u(e)}}}function Zi(o,e,n){let{href:i=""}=e,{title:t=""}=e,{text:r=""}=e;return console.log(i),o.$$set=a=>{"href"in a&&n(0,i=a.href),"title"in a&&n(1,t=a.title),"text"in a&&n(2,r=a.text)},[i,t,r]}class Qi extends E{constructor(e){super(),C(this,e,Zi,Ji,N,{href:0,title:1,text:2})}}function rt(o){let e,n;return e=new Hi({props:{source:o[0]+" ",renderers:{image:Qi}}}),{c(){z(e.$$.fragment)},l(i){W(e.$$.fragment,i)},m(i,t){B(e,i,t),n=!0},p(i,t){const r={};t&1&&(r.source=i[0]+" "),e.$set(r)},i(i){n||(d(e.$$.fragment,i),n=!0)},o(i){h(e.$$.fragment,i),n=!1},d(i){$(e,i)}}}function Yi(o){let e,n,i=o[0].length!=0&&rt(o);return{c(){i&&i.c(),e=y()},l(t){i&&i.l(t),e=y()},m(t,r){i&&i.m(t,r),f(t,e,r),n=!0},p(t,[r]){t[0].length!=0?i?(i.p(t,r),r&1&&d(i,1)):(i=rt(t),i.c(),d(i,1),i.m(e.parentNode,e)):i&&(R(),h(i,1,1,()=>{i=null}),M())},i(t){n||(d(i),n=!0)},o(t){h(i),n=!1},d(t){i&&i.d(t),t&&u(e)}}}const Xi=/\[[#A-Za-z:,?-]+\]/gi;function er(o){let e=o.match(Xi);return e!=null?e.flatMap(n=>n.substring(1,n.length-1).split(",")):[]}function tr(o,e,n){let i,t,r,a,l,s;De(o,ht,x=>n(6,s=x));let{block:c}=e,{filter:m}=e;function p(x,I){let G="";for(let J=0;J<I.length;J++)_(I[J],a[J],x)&&(G+=I[J]+`
`);return G.trim()}function w(x,I){return s.tagSearch&&x!=null&&x.includes(I)}function g(x,I){return s.fullTextSearch&&x.toLowerCase().includes(I.toLowerCase())}function T(){return s.keepHeader&&i}function _(x,I,G){return G==""||T()||g(x,G)||w(I,G)}return o.$$set=x=>{"block"in x&&n(1,c=x.block),"filter"in x&&n(2,m=x.filter)},o.$$.update=()=>{o.$$.dirty&2&&(i=c.trim().startsWith("#")),o.$$.dirty&2&&n(5,t=c.split(`
`)),o.$$.dirty&32&&n(4,r=t.map(x=>x.replace(/(\[[#A-Za-z:,?-]+\])/g,""))),o.$$.dirty&96&&n(3,a=s.tagSearch?t.map(x=>er(x)):[]),o.$$.dirty&20&&n(0,l=p(m,r)),o.$$.dirty&8&&a.forEach(x=>x.forEach(I=>xe.add(I)))},[l,c,m,a,r,t,s]}class nr extends E{constructor(e){super(),C(this,e,tr,Yi,N,{block:1,filter:2})}}function at(o,e,n){const i=o.slice();return i[2]=e[n],i}function ot(o){let e,n;return e=new nr({props:{filter:o[0],block:o[2]}}),{c(){z(e.$$.fragment)},l(i){W(e.$$.fragment,i)},m(i,t){B(e,i,t),n=!0},p(i,t){const r={};t&1&&(r.filter=i[0]),t&2&&(r.block=i[2]),e.$set(r)},i(i){n||(d(e.$$.fragment,i),n=!0)},o(i){h(e.$$.fragment,i),n=!1},d(i){$(e,i)}}}function ir(o){let e,n,i=o[1],t=[];for(let a=0;a<i.length;a+=1)t[a]=ot(at(o,i,a));const r=a=>h(t[a],1,1,()=>{t[a]=null});return{c(){for(let a=0;a<t.length;a+=1)t[a].c();e=y()},l(a){for(let l=0;l<t.length;l+=1)t[l].l(a);e=y()},m(a,l){for(let s=0;s<t.length;s+=1)t[s].m(a,l);f(a,e,l),n=!0},p(a,[l]){if(l&3){i=a[1];let s;for(s=0;s<i.length;s+=1){const c=at(a,i,s);t[s]?(t[s].p(c,l),d(t[s],1)):(t[s]=ot(c),t[s].c(),d(t[s],1),t[s].m(e.parentNode,e))}for(R(),s=i.length;s<t.length;s+=1)r(s);M()}},i(a){if(!n){for(let l=0;l<i.length;l+=1)d(t[l]);n=!0}},o(a){t=t.filter(Boolean);for(let l=0;l<t.length;l+=1)h(t[l]);n=!1},d(a){oe(t,a),a&&u(e)}}}function rr(o,e,n){let{searchTerm:i=""}=e,{textBlocks:t}=e;return o.$$set=r=>{"searchTerm"in r&&n(0,i=r.searchTerm),"textBlocks"in r&&n(1,t=r.textBlocks)},[i,t]}class ar extends E{constructor(e){super(),C(this,e,rr,ir,N,{searchTerm:0,textBlocks:1})}}const or=`
