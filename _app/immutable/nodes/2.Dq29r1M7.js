var Gt=Object.defineProperty;var Nt=(s,e,n)=>e in s?Gt(s,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):s[e]=n;var J=(s,e,n)=>(Nt(s,typeof e!="symbol"?e+"":e,n),n),qt=(s,e,n)=>{if(!e.has(s))throw TypeError("Cannot "+n)};var Be=(s,e,n)=>{if(e.has(s))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(s):e.set(s,n)};var Te=(s,e,n)=>(qt(s,e,"access private method"),n);import{s as z,e as P,c as C,f as D,d as m,i as T,G as Ft,k as y,W as He,C as pe,n as K,R as le,r as Tt,t as be,g as ve,X as Ae,j as ce,y as ke,Y as _t,Z as jt,w as Pt,u as k,_ as Ke,$ as X,a0 as Lt,A as F,a as ee,b as te,a1 as Wt,S as j,T as L,U as W,V as H,a2 as xe,a3 as Ct,a4 as At,a5 as Ht,a6 as Kt,l as Se,a7 as Ve,a8 as xt,z as Me,h as Vt,q as Yt,a9 as Ye}from"../chunks/scheduler.Dh7gh8aA.js";import{S as O,i as B,g as M,t as d,c as G,a as h,b as A,d as N,m as x,e as I,f as Ue}from"../chunks/index.D7BpNTuF.js";import{e as U}from"../chunks/each.D6YF6ztN.js";import{c as Ut}from"../chunks/config.CuJhE0wr.js";import{d as qe,w as It}from"../chunks/index.Dagk0nEk.js";function re(s,e){const n={},i={},t={$$scope:1};let r=s.length;for(;r--;){const o=s[r],l=e[r];if(l){for(const a in o)a in l||(i[a]=1);for(const a in l)t[a]||(n[a]=l[a],t[a]=1);s[r]=l}else for(const a in o)t[a]=1}for(const o in i)o in n||(n[o]=void 0);return n}function oe(s){return typeof s=="object"&&s!==null?s:{}}function Ze(s,e,n){const i=s.slice();return i[4]=e[n],i}function Je(s){let e,n=s[4].replaceAll("_"," ")+"",i,t;return{c(){e=P("option"),i=be(n),this.h()},l(r){e=C(r,"OPTION",{});var o=D(e);i=ve(o,n),o.forEach(m),this.h()},h(){e.__value=t=s[4],Ae(e,e.__value)},m(r,o){y(r,e,o),ce(e,i)},p(r,o){o&2&&n!==(n=r[4].replaceAll("_"," ")+"")&&ke(i,n),o&2&&t!==(t=r[4])&&(e.__value=t,Ae(e,e.__value))},d(r){r&&m(e)}}}function Zt(s){let e,n,i,t=U(s[1]),r=[];for(let o=0;o<t.length;o+=1)r[o]=Je(Ze(s,t,o));return{c(){e=P("select");for(let o=0;o<r.length;o+=1)r[o].c();this.h()},l(o){e=C(o,"SELECT",{id:!0,class:!0});var l=D(e);for(let a=0;a<r.length;a+=1)r[a].l(l);l.forEach(m),this.h()},h(){T(e,"id","select"),T(e,"class","svelte-1i9xen5"),s[0]===void 0&&Ft(()=>s[3].call(e))},m(o,l){y(o,e,l);for(let a=0;a<r.length;a+=1)r[a]&&r[a].m(e,null);He(e,s[0],!0),n||(i=[pe(e,"change",s[2]),pe(e,"change",s[3])],n=!0)},p(o,[l]){if(l&2){t=U(o[1]);let a;for(a=0;a<t.length;a+=1){const c=Ze(o,t,a);r[a]?r[a].p(c,l):(r[a]=Je(c),r[a].c(),r[a].m(e,null))}for(;a<r.length;a+=1)r[a].d(1);r.length=t.length}l&3&&He(e,o[0])},i:K,o:K,d(o){o&&m(e),le(r,o),n=!1,Tt(i)}}}function Jt(s,e,n){let{selectedGuide:i=""}=e,{options:t}=e;function r(l){_t.call(this,s,l)}function o(){i=jt(this),n(0,i),n(1,t)}return s.$$set=l=>{"selectedGuide"in l&&n(0,i=l.selectedGuide),"options"in l&&n(1,t=l.options)},[i,t,r,o]}class Qt extends O{constructor(e){super(),B(this,e,Jt,Zt,z,{selectedGuide:0,options:1})}}function Xt(){const s=console.warn;console.warn=e=>{e.includes("unknown prop")||e.includes("unexpected slot")||s(e)},Pt(()=>{console.warn=s})}function Qe(s,e,n){const i=s.slice();return i[18]=e[n],i}function Xe(s,e,n){const i=s.slice();return i[18]=e[n],i}function et(s,e,n){const i=s.slice();return i[10]=e[n],i}function tt(s,e,n){const i=s.slice();return i[13]=e[n],i[15]=n,i}function nt(s,e,n){const i=s.slice();return i[16]=e[n],i[15]=n,i}function it(s,e,n){const i=s.slice();return i[7]=e[n],i}function en(s){let e,n,i,t;const r=[on,rn,nn],o=[];function l(a,c){return a[0]==="table"?0:a[0]==="list"?1:2}return e=l(s),n=o[e]=r[e](s),{c(){n.c(),i=k()},l(a){n.l(a),i=k()},m(a,c){o[e].m(a,c),y(a,i,c),t=!0},p(a,c){let u=e;e=l(a),e===u?o[e].p(a,c):(M(),d(o[u],1,1,()=>{o[u]=null}),G(),n=o[e],n?n.p(a,c):(n=o[e]=r[e](a),n.c()),h(n,1),n.m(i.parentNode,i))},i(a){t||(h(n),t=!0)},o(a){d(n),t=!1},d(a){a&&m(i),o[e].d(a)}}}function tn(s){let e,n,i=U(s[1]),t=[];for(let o=0;o<i.length;o+=1)t[o]=ct(it(s,i,o));const r=o=>d(t[o],1,1,()=>{t[o]=null});return{c(){for(let o=0;o<t.length;o+=1)t[o].c();e=k()},l(o){for(let l=0;l<t.length;l+=1)t[l].l(o);e=k()},m(o,l){for(let a=0;a<t.length;a+=1)t[a]&&t[a].m(o,l);y(o,e,l),n=!0},p(o,l){if(l&34){i=U(o[1]);let a;for(a=0;a<i.length;a+=1){const c=it(o,i,a);t[a]?(t[a].p(c,l),h(t[a],1)):(t[a]=ct(c),t[a].c(),h(t[a],1),t[a].m(e.parentNode,e))}for(M(),a=i.length;a<t.length;a+=1)r(a);G()}},i(o){if(!n){for(let l=0;l<i.length;l+=1)h(t[l]);n=!0}},o(o){t=t.filter(Boolean);for(let l=0;l<t.length;l+=1)d(t[l]);n=!1},d(o){o&&m(e),le(t,o)}}}function nn(s){let e,n,i;const t=[s[6]];var r=s[5][s[0]];function o(l,a){let c={$$slots:{default:[ln]},$$scope:{ctx:l}};for(let u=0;u<t.length;u+=1)c=X(c,t[u]);return a!==void 0&&a&64&&(c=X(c,re(t,[oe(l[6])]))),{props:c}}return r&&(e=F(r,o(s))),{c(){e&&A(e.$$.fragment),n=k()},l(l){e&&N(e.$$.fragment,l),n=k()},m(l,a){e&&x(e,l,a),y(l,n,a),i=!0},p(l,a){if(a&33&&r!==(r=l[5][l[0]])){if(e){M();const c=e;d(c.$$.fragment,1,0,()=>{I(c,1)}),G()}r?(e=F(r,o(l,a)),A(e.$$.fragment),h(e.$$.fragment,1),x(e,n.parentNode,n)):e=null}else if(r){const c=a&64?re(t,[oe(l[6])]):{};a&8388706&&(c.$$scope={dirty:a,ctx:l}),e.$set(c)}},i(l){i||(e&&h(e.$$.fragment,l),i=!0)},o(l){e&&d(e.$$.fragment,l),i=!1},d(l){l&&m(n),e&&I(e,l)}}}function rn(s){let e,n,i,t;const r=[un,cn],o=[];function l(a,c){return a[4]?0:1}return e=l(s),n=o[e]=r[e](s),{c(){n.c(),i=k()},l(a){n.l(a),i=k()},m(a,c){o[e].m(a,c),y(a,i,c),t=!0},p(a,c){let u=e;e=l(a),e===u?o[e].p(a,c):(M(),d(o[u],1,1,()=>{o[u]=null}),G(),n=o[e],n?n.p(a,c):(n=o[e]=r[e](a),n.c()),h(n,1),n.m(i.parentNode,i))},i(a){t||(h(n),t=!0)},o(a){d(n),t=!1},d(a){a&&m(i),o[e].d(a)}}}function on(s){let e,n,i;var t=s[5].table;function r(o,l){return{props:{$$slots:{default:[vn]},$$scope:{ctx:o}}}}return t&&(e=F(t,r(s))),{c(){e&&A(e.$$.fragment),n=k()},l(o){e&&N(e.$$.fragment,o),n=k()},m(o,l){e&&x(e,o,l),y(o,n,l),i=!0},p(o,l){if(l&32&&t!==(t=o[5].table)){if(e){M();const a=e;d(a.$$.fragment,1,0,()=>{I(a,1)}),G()}t?(e=F(t,r(o)),A(e.$$.fragment),h(e.$$.fragment,1),x(e,n.parentNode,n)):e=null}else if(t){const a={};l&8388716&&(a.$$scope={dirty:l,ctx:o}),e.$set(a)}},i(o){i||(e&&h(e.$$.fragment,o),i=!0)},o(o){e&&d(e.$$.fragment,o),i=!1},d(o){o&&m(n),e&&I(e,o)}}}function an(s){let e=s[6].raw+"",n;return{c(){n=be(e)},l(i){n=ve(i,e)},m(i,t){y(i,n,t)},p(i,t){t&64&&e!==(e=i[6].raw+"")&&ke(n,e)},i:K,o:K,d(i){i&&m(n)}}}function sn(s){let e,n;return e=new de({props:{tokens:s[1],renderers:s[5]}}),{c(){A(e.$$.fragment)},l(i){N(e.$$.fragment,i)},m(i,t){x(e,i,t),n=!0},p(i,t){const r={};t&2&&(r.tokens=i[1]),t&32&&(r.renderers=i[5]),e.$set(r)},i(i){n||(h(e.$$.fragment,i),n=!0)},o(i){d(e.$$.fragment,i),n=!1},d(i){I(e,i)}}}function ln(s){let e,n,i,t;const r=[sn,an],o=[];function l(a,c){return a[1]?0:1}return e=l(s),n=o[e]=r[e](s),{c(){n.c(),i=k()},l(a){n.l(a),i=k()},m(a,c){o[e].m(a,c),y(a,i,c),t=!0},p(a,c){let u=e;e=l(a),e===u?o[e].p(a,c):(M(),d(o[u],1,1,()=>{o[u]=null}),G(),n=o[e],n?n.p(a,c):(n=o[e]=r[e](a),n.c()),h(n,1),n.m(i.parentNode,i))},i(a){t||(h(n),t=!0)},o(a){d(n),t=!1},d(a){a&&m(i),o[e].d(a)}}}function cn(s){let e,n,i;const t=[{ordered:s[4]},s[6]];var r=s[5].list;function o(l,a){let c={$$slots:{default:[hn]},$$scope:{ctx:l}};for(let u=0;u<t.length;u+=1)c=X(c,t[u]);return a!==void 0&&a&80&&(c=X(c,re(t,[a&16&&{ordered:l[4]},a&64&&oe(l[6])]))),{props:c}}return r&&(e=F(r,o(s))),{c(){e&&A(e.$$.fragment),n=k()},l(l){e&&N(e.$$.fragment,l),n=k()},m(l,a){e&&x(e,l,a),y(l,n,a),i=!0},p(l,a){if(a&32&&r!==(r=l[5].list)){if(e){M();const c=e;d(c.$$.fragment,1,0,()=>{I(c,1)}),G()}r?(e=F(r,o(l,a)),A(e.$$.fragment),h(e.$$.fragment,1),x(e,n.parentNode,n)):e=null}else if(r){const c=a&80?re(t,[a&16&&{ordered:l[4]},a&64&&oe(l[6])]):{};a&8388704&&(c.$$scope={dirty:a,ctx:l}),e.$set(c)}},i(l){i||(e&&h(e.$$.fragment,l),i=!0)},o(l){e&&d(e.$$.fragment,l),i=!1},d(l){l&&m(n),e&&I(e,l)}}}function un(s){let e,n,i;const t=[{ordered:s[4]},s[6]];var r=s[5].list;function o(l,a){let c={$$slots:{default:[pn]},$$scope:{ctx:l}};for(let u=0;u<t.length;u+=1)c=X(c,t[u]);return a!==void 0&&a&80&&(c=X(c,re(t,[a&16&&{ordered:l[4]},a&64&&oe(l[6])]))),{props:c}}return r&&(e=F(r,o(s))),{c(){e&&A(e.$$.fragment),n=k()},l(l){e&&N(e.$$.fragment,l),n=k()},m(l,a){e&&x(e,l,a),y(l,n,a),i=!0},p(l,a){if(a&32&&r!==(r=l[5].list)){if(e){M();const c=e;d(c.$$.fragment,1,0,()=>{I(c,1)}),G()}r?(e=F(r,o(l,a)),A(e.$$.fragment),h(e.$$.fragment,1),x(e,n.parentNode,n)):e=null}else if(r){const c=a&80?re(t,[a&16&&{ordered:l[4]},a&64&&oe(l[6])]):{};a&8388704&&(c.$$scope={dirty:a,ctx:l}),e.$set(c)}},i(l){i||(e&&h(e.$$.fragment,l),i=!0)},o(l){e&&d(e.$$.fragment,l),i=!1},d(l){l&&m(n),e&&I(e,l)}}}function mn(s){let e,n,i;return e=new de({props:{tokens:s[18].tokens,renderers:s[5]}}),{c(){A(e.$$.fragment),n=ee()},l(t){N(e.$$.fragment,t),n=te(t)},m(t,r){x(e,t,r),y(t,n,r),i=!0},p(t,r){const o={};r&64&&(o.tokens=t[18].tokens),r&32&&(o.renderers=t[5]),e.$set(o)},i(t){i||(h(e.$$.fragment,t),i=!0)},o(t){d(e.$$.fragment,t),i=!1},d(t){t&&m(n),I(e,t)}}}function rt(s){let e,n,i;const t=[s[18]];var r=s[5].unorderedlistitem||s[5].listitem;function o(l,a){let c={$$slots:{default:[mn]},$$scope:{ctx:l}};for(let u=0;u<t.length;u+=1)c=X(c,t[u]);return a!==void 0&&a&64&&(c=X(c,re(t,[oe(l[18])]))),{props:c}}return r&&(e=F(r,o(s))),{c(){e&&A(e.$$.fragment),n=k()},l(l){e&&N(e.$$.fragment,l),n=k()},m(l,a){e&&x(e,l,a),y(l,n,a),i=!0},p(l,a){if(a&32&&r!==(r=l[5].unorderedlistitem||l[5].listitem)){if(e){M();const c=e;d(c.$$.fragment,1,0,()=>{I(c,1)}),G()}r?(e=F(r,o(l,a)),A(e.$$.fragment),h(e.$$.fragment,1),x(e,n.parentNode,n)):e=null}else if(r){const c=a&64?re(t,[oe(l[18])]):{};a&8388704&&(c.$$scope={dirty:a,ctx:l}),e.$set(c)}},i(l){i||(e&&h(e.$$.fragment,l),i=!0)},o(l){e&&d(e.$$.fragment,l),i=!1},d(l){l&&m(n),e&&I(e,l)}}}function hn(s){let e,n,i=U(s[6].items),t=[];for(let o=0;o<i.length;o+=1)t[o]=rt(Qe(s,i,o));const r=o=>d(t[o],1,1,()=>{t[o]=null});return{c(){for(let o=0;o<t.length;o+=1)t[o].c();e=k()},l(o){for(let l=0;l<t.length;l+=1)t[l].l(o);e=k()},m(o,l){for(let a=0;a<t.length;a+=1)t[a]&&t[a].m(o,l);y(o,e,l),n=!0},p(o,l){if(l&96){i=U(o[6].items);let a;for(a=0;a<i.length;a+=1){const c=Qe(o,i,a);t[a]?(t[a].p(c,l),h(t[a],1)):(t[a]=rt(c),t[a].c(),h(t[a],1),t[a].m(e.parentNode,e))}for(M(),a=i.length;a<t.length;a+=1)r(a);G()}},i(o){if(!n){for(let l=0;l<i.length;l+=1)h(t[l]);n=!0}},o(o){t=t.filter(Boolean);for(let l=0;l<t.length;l+=1)d(t[l]);n=!1},d(o){o&&m(e),le(t,o)}}}function dn(s){let e,n,i;return e=new de({props:{tokens:s[18].tokens,renderers:s[5]}}),{c(){A(e.$$.fragment),n=ee()},l(t){N(e.$$.fragment,t),n=te(t)},m(t,r){x(e,t,r),y(t,n,r),i=!0},p(t,r){const o={};r&64&&(o.tokens=t[18].tokens),r&32&&(o.renderers=t[5]),e.$set(o)},i(t){i||(h(e.$$.fragment,t),i=!0)},o(t){d(e.$$.fragment,t),i=!1},d(t){t&&m(n),I(e,t)}}}function ot(s){let e,n,i;const t=[s[18]];var r=s[5].orderedlistitem||s[5].listitem;function o(l,a){let c={$$slots:{default:[dn]},$$scope:{ctx:l}};for(let u=0;u<t.length;u+=1)c=X(c,t[u]);return a!==void 0&&a&64&&(c=X(c,re(t,[oe(l[18])]))),{props:c}}return r&&(e=F(r,o(s))),{c(){e&&A(e.$$.fragment),n=k()},l(l){e&&N(e.$$.fragment,l),n=k()},m(l,a){e&&x(e,l,a),y(l,n,a),i=!0},p(l,a){if(a&32&&r!==(r=l[5].orderedlistitem||l[5].listitem)){if(e){M();const c=e;d(c.$$.fragment,1,0,()=>{I(c,1)}),G()}r?(e=F(r,o(l,a)),A(e.$$.fragment),h(e.$$.fragment,1),x(e,n.parentNode,n)):e=null}else if(r){const c=a&64?re(t,[oe(l[18])]):{};a&8388704&&(c.$$scope={dirty:a,ctx:l}),e.$set(c)}},i(l){i||(e&&h(e.$$.fragment,l),i=!0)},o(l){e&&d(e.$$.fragment,l),i=!1},d(l){l&&m(n),e&&I(e,l)}}}function pn(s){let e,n,i=U(s[6].items),t=[];for(let o=0;o<i.length;o+=1)t[o]=ot(Xe(s,i,o));const r=o=>d(t[o],1,1,()=>{t[o]=null});return{c(){for(let o=0;o<t.length;o+=1)t[o].c();e=k()},l(o){for(let l=0;l<t.length;l+=1)t[l].l(o);e=k()},m(o,l){for(let a=0;a<t.length;a+=1)t[a]&&t[a].m(o,l);y(o,e,l),n=!0},p(o,l){if(l&96){i=U(o[6].items);let a;for(a=0;a<i.length;a+=1){const c=Xe(o,i,a);t[a]?(t[a].p(c,l),h(t[a],1)):(t[a]=ot(c),t[a].c(),h(t[a],1),t[a].m(e.parentNode,e))}for(M(),a=i.length;a<t.length;a+=1)r(a);G()}},i(o){if(!n){for(let l=0;l<i.length;l+=1)h(t[l]);n=!0}},o(o){t=t.filter(Boolean);for(let l=0;l<t.length;l+=1)d(t[l]);n=!1},d(o){o&&m(e),le(t,o)}}}function fn(s){let e,n,i;return e=new de({props:{tokens:s[16].tokens,renderers:s[5]}}),{c(){A(e.$$.fragment),n=ee()},l(t){N(e.$$.fragment,t),n=te(t)},m(t,r){x(e,t,r),y(t,n,r),i=!0},p(t,r){const o={};r&4&&(o.tokens=t[16].tokens),r&32&&(o.renderers=t[5]),e.$set(o)},i(t){i||(h(e.$$.fragment,t),i=!0)},o(t){d(e.$$.fragment,t),i=!1},d(t){t&&m(n),I(e,t)}}}function at(s){let e,n,i;var t=s[5].tablecell;function r(o,l){return{props:{header:!0,align:o[6].align[o[15]]||"center",$$slots:{default:[fn]},$$scope:{ctx:o}}}}return t&&(e=F(t,r(s))),{c(){e&&A(e.$$.fragment),n=k()},l(o){e&&N(e.$$.fragment,o),n=k()},m(o,l){e&&x(e,o,l),y(o,n,l),i=!0},p(o,l){if(l&32&&t!==(t=o[5].tablecell)){if(e){M();const a=e;d(a.$$.fragment,1,0,()=>{I(a,1)}),G()}t?(e=F(t,r(o)),A(e.$$.fragment),h(e.$$.fragment,1),x(e,n.parentNode,n)):e=null}else if(t){const a={};l&64&&(a.align=o[6].align[o[15]]||"center"),l&8388644&&(a.$$scope={dirty:l,ctx:o}),e.$set(a)}},i(o){i||(e&&h(e.$$.fragment,o),i=!0)},o(o){e&&d(e.$$.fragment,o),i=!1},d(o){o&&m(n),e&&I(e,o)}}}function gn(s){let e,n,i=U(s[2]),t=[];for(let o=0;o<i.length;o+=1)t[o]=at(nt(s,i,o));const r=o=>d(t[o],1,1,()=>{t[o]=null});return{c(){for(let o=0;o<t.length;o+=1)t[o].c();e=k()},l(o){for(let l=0;l<t.length;l+=1)t[l].l(o);e=k()},m(o,l){for(let a=0;a<t.length;a+=1)t[a]&&t[a].m(o,l);y(o,e,l),n=!0},p(o,l){if(l&100){i=U(o[2]);let a;for(a=0;a<i.length;a+=1){const c=nt(o,i,a);t[a]?(t[a].p(c,l),h(t[a],1)):(t[a]=at(c),t[a].c(),h(t[a],1),t[a].m(e.parentNode,e))}for(M(),a=i.length;a<t.length;a+=1)r(a);G()}},i(o){if(!n){for(let l=0;l<i.length;l+=1)h(t[l]);n=!0}},o(o){t=t.filter(Boolean);for(let l=0;l<t.length;l+=1)d(t[l]);n=!1},d(o){o&&m(e),le(t,o)}}}function yn(s){let e,n,i;var t=s[5].tablerow;function r(o,l){return{props:{$$slots:{default:[gn]},$$scope:{ctx:o}}}}return t&&(e=F(t,r(s))),{c(){e&&A(e.$$.fragment),n=k()},l(o){e&&N(e.$$.fragment,o),n=k()},m(o,l){e&&x(e,o,l),y(o,n,l),i=!0},p(o,l){if(l&32&&t!==(t=o[5].tablerow)){if(e){M();const a=e;d(a.$$.fragment,1,0,()=>{I(a,1)}),G()}t?(e=F(t,r(o)),A(e.$$.fragment),h(e.$$.fragment,1),x(e,n.parentNode,n)):e=null}else if(t){const a={};l&8388708&&(a.$$scope={dirty:l,ctx:o}),e.$set(a)}},i(o){i||(e&&h(e.$$.fragment,o),i=!0)},o(o){e&&d(e.$$.fragment,o),i=!1},d(o){o&&m(n),e&&I(e,o)}}}function Sn(s){let e,n;return e=new de({props:{tokens:s[13].tokens,renderers:s[5]}}),{c(){A(e.$$.fragment)},l(i){N(e.$$.fragment,i)},m(i,t){x(e,i,t),n=!0},p(i,t){const r={};t&8&&(r.tokens=i[13].tokens),t&32&&(r.renderers=i[5]),e.$set(r)},i(i){n||(h(e.$$.fragment,i),n=!0)},o(i){d(e.$$.fragment,i),n=!1},d(i){I(e,i)}}}function st(s){let e,n,i;var t=s[5].tablecell;function r(o,l){return{props:{header:!1,align:o[6].align[o[15]]||"center",$$slots:{default:[Sn]},$$scope:{ctx:o}}}}return t&&(e=F(t,r(s))),{c(){e&&A(e.$$.fragment),n=k()},l(o){e&&N(e.$$.fragment,o),n=k()},m(o,l){e&&x(e,o,l),y(o,n,l),i=!0},p(o,l){if(l&32&&t!==(t=o[5].tablecell)){if(e){M();const a=e;d(a.$$.fragment,1,0,()=>{I(a,1)}),G()}t?(e=F(t,r(o)),A(e.$$.fragment),h(e.$$.fragment,1),x(e,n.parentNode,n)):e=null}else if(t){const a={};l&64&&(a.align=o[6].align[o[15]]||"center"),l&8388648&&(a.$$scope={dirty:l,ctx:o}),e.$set(a)}},i(o){i||(e&&h(e.$$.fragment,o),i=!0)},o(o){e&&d(e.$$.fragment,o),i=!1},d(o){o&&m(n),e&&I(e,o)}}}function wn(s){let e,n,i=U(s[10]),t=[];for(let o=0;o<i.length;o+=1)t[o]=st(tt(s,i,o));const r=o=>d(t[o],1,1,()=>{t[o]=null});return{c(){for(let o=0;o<t.length;o+=1)t[o].c();e=ee()},l(o){for(let l=0;l<t.length;l+=1)t[l].l(o);e=te(o)},m(o,l){for(let a=0;a<t.length;a+=1)t[a]&&t[a].m(o,l);y(o,e,l),n=!0},p(o,l){if(l&104){i=U(o[10]);let a;for(a=0;a<i.length;a+=1){const c=tt(o,i,a);t[a]?(t[a].p(c,l),h(t[a],1)):(t[a]=st(c),t[a].c(),h(t[a],1),t[a].m(e.parentNode,e))}for(M(),a=i.length;a<t.length;a+=1)r(a);G()}},i(o){if(!n){for(let l=0;l<i.length;l+=1)h(t[l]);n=!0}},o(o){t=t.filter(Boolean);for(let l=0;l<t.length;l+=1)d(t[l]);n=!1},d(o){o&&m(e),le(t,o)}}}function lt(s){let e,n,i;var t=s[5].tablerow;function r(o,l){return{props:{$$slots:{default:[wn]},$$scope:{ctx:o}}}}return t&&(e=F(t,r(s))),{c(){e&&A(e.$$.fragment),n=k()},l(o){e&&N(e.$$.fragment,o),n=k()},m(o,l){e&&x(e,o,l),y(o,n,l),i=!0},p(o,l){if(l&32&&t!==(t=o[5].tablerow)){if(e){M();const a=e;d(a.$$.fragment,1,0,()=>{I(a,1)}),G()}t?(e=F(t,r(o)),A(e.$$.fragment),h(e.$$.fragment,1),x(e,n.parentNode,n)):e=null}else if(t){const a={};l&8388712&&(a.$$scope={dirty:l,ctx:o}),e.$set(a)}},i(o){i||(e&&h(e.$$.fragment,o),i=!0)},o(o){e&&d(e.$$.fragment,o),i=!1},d(o){o&&m(n),e&&I(e,o)}}}function bn(s){let e,n,i=U(s[3]),t=[];for(let o=0;o<i.length;o+=1)t[o]=lt(et(s,i,o));const r=o=>d(t[o],1,1,()=>{t[o]=null});return{c(){for(let o=0;o<t.length;o+=1)t[o].c();e=k()},l(o){for(let l=0;l<t.length;l+=1)t[l].l(o);e=k()},m(o,l){for(let a=0;a<t.length;a+=1)t[a]&&t[a].m(o,l);y(o,e,l),n=!0},p(o,l){if(l&104){i=U(o[3]);let a;for(a=0;a<i.length;a+=1){const c=et(o,i,a);t[a]?(t[a].p(c,l),h(t[a],1)):(t[a]=lt(c),t[a].c(),h(t[a],1),t[a].m(e.parentNode,e))}for(M(),a=i.length;a<t.length;a+=1)r(a);G()}},i(o){if(!n){for(let l=0;l<i.length;l+=1)h(t[l]);n=!0}},o(o){t=t.filter(Boolean);for(let l=0;l<t.length;l+=1)d(t[l]);n=!1},d(o){o&&m(e),le(t,o)}}}function vn(s){let e,n,i,t,r;var o=s[5].tablehead;function l(u,g){return{props:{$$slots:{default:[yn]},$$scope:{ctx:u}}}}o&&(e=F(o,l(s)));var a=s[5].tablebody;function c(u,g){return{props:{$$slots:{default:[bn]},$$scope:{ctx:u}}}}return a&&(i=F(a,c(s))),{c(){e&&A(e.$$.fragment),n=ee(),i&&A(i.$$.fragment),t=k()},l(u){e&&N(e.$$.fragment,u),n=te(u),i&&N(i.$$.fragment,u),t=k()},m(u,g){e&&x(e,u,g),y(u,n,g),i&&x(i,u,g),y(u,t,g),r=!0},p(u,g){if(g&32&&o!==(o=u[5].tablehead)){if(e){M();const p=e;d(p.$$.fragment,1,0,()=>{I(p,1)}),G()}o?(e=F(o,l(u)),A(e.$$.fragment),h(e.$$.fragment,1),x(e,n.parentNode,n)):e=null}else if(o){const p={};g&8388708&&(p.$$scope={dirty:g,ctx:u}),e.$set(p)}if(g&32&&a!==(a=u[5].tablebody)){if(i){M();const p=i;d(p.$$.fragment,1,0,()=>{I(p,1)}),G()}a?(i=F(a,c(u)),A(i.$$.fragment),h(i.$$.fragment,1),x(i,t.parentNode,t)):i=null}else if(a){const p={};g&8388712&&(p.$$scope={dirty:g,ctx:u}),i.$set(p)}},i(u){r||(e&&h(e.$$.fragment,u),i&&h(i.$$.fragment,u),r=!0)},o(u){e&&d(e.$$.fragment,u),i&&d(i.$$.fragment,u),r=!1},d(u){u&&(m(n),m(t)),e&&I(e,u),i&&I(i,u)}}}function ct(s){let e,n;const i=[s[7],{renderers:s[5]}];let t={};for(let r=0;r<i.length;r+=1)t=X(t,i[r]);return e=new de({props:t}),{c(){A(e.$$.fragment)},l(r){N(e.$$.fragment,r)},m(r,o){x(e,r,o),n=!0},p(r,o){const l=o&34?re(i,[o&2&&oe(r[7]),o&32&&{renderers:r[5]}]):{};e.$set(l)},i(r){n||(h(e.$$.fragment,r),n=!0)},o(r){d(e.$$.fragment,r),n=!1},d(r){I(e,r)}}}function kn(s){let e,n,i,t;const r=[tn,en],o=[];function l(a,c){return a[0]?a[5][a[0]]?1:-1:0}return~(e=l(s))&&(n=o[e]=r[e](s)),{c(){n&&n.c(),i=k()},l(a){n&&n.l(a),i=k()},m(a,c){~e&&o[e].m(a,c),y(a,i,c),t=!0},p(a,[c]){let u=e;e=l(a),e===u?~e&&o[e].p(a,c):(n&&(M(),d(o[u],1,1,()=>{o[u]=null}),G()),~e?(n=o[e],n?n.p(a,c):(n=o[e]=r[e](a),n.c()),h(n,1),n.m(i.parentNode,i)):n=null)},i(a){t||(h(n),t=!0)},o(a){d(n),t=!1},d(a){a&&m(i),~e&&o[e].d(a)}}}function Tn(s,e,n){const i=["type","tokens","header","rows","ordered","renderers"];let t=Ke(e,i),{type:r=void 0}=e,{tokens:o=void 0}=e,{header:l=void 0}=e,{rows:a=void 0}=e,{ordered:c=!1}=e,{renderers:u}=e;return Xt(),s.$$set=g=>{e=X(X({},e),Lt(g)),n(6,t=Ke(e,i)),"type"in g&&n(0,r=g.type),"tokens"in g&&n(1,o=g.tokens),"header"in g&&n(2,l=g.header),"rows"in g&&n(3,a=g.rows),"ordered"in g&&n(4,c=g.ordered),"renderers"in g&&n(5,u=g.renderers)},[r,o,l,a,c,u,t]}let de=class extends O{constructor(e){super(),B(this,e,Tn,kn,z,{type:0,tokens:1,header:2,rows:3,ordered:4,renderers:5})}};function Fe(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}let me=Fe();function Rt(s){me=s}const Dt=/[&<>"']/,_n=new RegExp(Dt.source,"g"),$t=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Pn=new RegExp($t.source,"g"),Cn={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ut=s=>Cn[s];function Z(s,e){if(e){if(Dt.test(s))return s.replace(_n,ut)}else if($t.test(s))return s.replace(Pn,ut);return s}const An=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function zt(s){return s.replace(An,(e,n)=>(n=n.toLowerCase(),n==="colon"?":":n.charAt(0)==="#"?n.charAt(1)==="x"?String.fromCharCode(parseInt(n.substring(2),16)):String.fromCharCode(+n.substring(1)):""))}const xn=/(^|[^\[])\^/g;function $(s,e){s=typeof s=="string"?s:s.source,e=e||"";const n={replace:(i,t)=>(t=t.source||t,t=t.replace(xn,"$1"),s=s.replace(i,t),n),getRegex:()=>new RegExp(s,e)};return n}const In=/[^\w:]/g,Rn=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function mt(s,e,n){if(s){let i;try{i=decodeURIComponent(zt(n)).replace(In,"").toLowerCase()}catch{return null}if(i.indexOf("javascript:")===0||i.indexOf("vbscript:")===0||i.indexOf("data:")===0)return null}e&&!Rn.test(n)&&(n=On(e,n));try{n=encodeURI(n).replace(/%25/g,"%")}catch{return null}return n}const _e={},Dn=/^[^:]+:\/*[^/]*$/,$n=/^([^:]+:)[\s\S]*$/,zn=/^([^:]+:\/*[^/]*)[\s\S]*$/;function On(s,e){_e[" "+s]||(Dn.test(s)?_e[" "+s]=s+"/":_e[" "+s]=Ce(s,"/",!0)),s=_e[" "+s];const n=s.indexOf(":")===-1;return e.substring(0,2)==="//"?n?e:s.replace($n,"$1")+e:e.charAt(0)==="/"?n?e:s.replace(zn,"$1")+e:s+e}const Ie={exec:function(){}};function ht(s,e){const n=s.replace(/\|/g,(r,o,l)=>{let a=!1,c=o;for(;--c>=0&&l[c]==="\\";)a=!a;return a?"|":" |"}),i=n.split(/ \|/);let t=0;if(i[0].trim()||i.shift(),i.length>0&&!i[i.length-1].trim()&&i.pop(),i.length>e)i.splice(e);else for(;i.length<e;)i.push("");for(;t<i.length;t++)i[t]=i[t].trim().replace(/\\\|/g,"|");return i}function Ce(s,e,n){const i=s.length;if(i===0)return"";let t=0;for(;t<i;){const r=s.charAt(i-t-1);if(r===e&&!n)t++;else if(r!==e&&n)t++;else break}return s.slice(0,i-t)}function Bn(s,e){if(s.indexOf(e[1])===-1)return-1;const n=s.length;let i=0,t=0;for(;t<n;t++)if(s[t]==="\\")t++;else if(s[t]===e[0])i++;else if(s[t]===e[1]&&(i--,i<0))return t;return-1}function En(s,e){!s||s.silent||(e&&console.warn("marked(): callback is deprecated since version 5.0.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/using_pro#async"),(s.sanitize||s.sanitizer)&&console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options"),(s.highlight||s.langPrefix!=="language-")&&console.warn("marked(): highlight and langPrefix parameters are deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-highlight."),s.mangle&&console.warn("marked(): mangle parameter is enabled by default, but is deprecated since version 5.0.0, and will be removed in the future. To clear this warning, install https://www.npmjs.com/package/marked-mangle, or disable by setting `{mangle: false}`."),s.baseUrl&&console.warn("marked(): baseUrl parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-base-url."),s.smartypants&&console.warn("marked(): smartypants parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-smartypants."),s.xhtml&&console.warn("marked(): xhtml parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-xhtml."),(s.headerIds||s.headerPrefix)&&console.warn("marked(): headerIds and headerPrefix parameters enabled by default, but are deprecated since version 5.0.0, and will be removed in the future. To clear this warning, install  https://www.npmjs.com/package/marked-gfm-heading-id, or disable by setting `{headerIds: false}`."))}function dt(s,e,n,i){const t=e.href,r=e.title?Z(e.title):null,o=s[1].replace(/\\([\[\]])/g,"$1");if(s[0].charAt(0)!=="!"){i.state.inLink=!0;const l={type:"link",raw:n,href:t,title:r,text:o,tokens:i.inlineTokens(o)};return i.state.inLink=!1,l}return{type:"image",raw:n,href:t,title:r,text:Z(o)}}function Mn(s,e){const n=s.match(/^(\s+)(?:```)/);if(n===null)return e;const i=n[1];return e.split(`
`).map(t=>{const r=t.match(/^\s+/);if(r===null)return t;const[o]=r;return o.length>=i.length?t.slice(i.length):t}).join(`
`)}class Re{constructor(e){this.options=e||me}space(e){const n=this.rules.block.newline.exec(e);if(n&&n[0].length>0)return{type:"space",raw:n[0]}}code(e){const n=this.rules.block.code.exec(e);if(n){const i=n[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:n[0],codeBlockStyle:"indented",text:this.options.pedantic?i:Ce(i,`
`)}}}fences(e){const n=this.rules.block.fences.exec(e);if(n){const i=n[0],t=Mn(i,n[3]||"");return{type:"code",raw:i,lang:n[2]?n[2].trim().replace(this.rules.inline._escapes,"$1"):n[2],text:t}}}heading(e){const n=this.rules.block.heading.exec(e);if(n){let i=n[2].trim();if(/#$/.test(i)){const t=Ce(i,"#");(this.options.pedantic||!t||/ $/.test(t))&&(i=t.trim())}return{type:"heading",raw:n[0],depth:n[1].length,text:i,tokens:this.lexer.inline(i)}}}hr(e){const n=this.rules.block.hr.exec(e);if(n)return{type:"hr",raw:n[0]}}blockquote(e){const n=this.rules.block.blockquote.exec(e);if(n){const i=n[0].replace(/^ *>[ \t]?/gm,""),t=this.lexer.state.top;this.lexer.state.top=!0;const r=this.lexer.blockTokens(i);return this.lexer.state.top=t,{type:"blockquote",raw:n[0],tokens:r,text:i}}}list(e){let n=this.rules.block.list.exec(e);if(n){let i,t,r,o,l,a,c,u,g,p,f,w,_=n[1].trim();const V=_.length>1,R={type:"list",raw:"",ordered:V,start:V?+_.slice(0,-1):"",loose:!1,items:[]};_=V?`\\d{1,9}\\${_.slice(-1)}`:`\\${_}`,this.options.pedantic&&(_=V?_:"[*+-]");const Y=new RegExp(`^( {0,3}${_})((?:[	 ][^\\n]*)?(?:\\n|$))`);for(;e&&(w=!1,!(!(n=Y.exec(e))||this.rules.block.hr.test(e)));){if(i=n[0],e=e.substring(i.length),u=n[2].split(`
`,1)[0].replace(/^\t+/,ne=>" ".repeat(3*ne.length)),g=e.split(`
`,1)[0],this.options.pedantic?(o=2,f=u.trimLeft()):(o=n[2].search(/[^ ]/),o=o>4?1:o,f=u.slice(o),o+=n[1].length),a=!1,!u&&/^ *$/.test(g)&&(i+=g+`
`,e=e.substring(g.length+1),w=!0),!w){const ne=new RegExp(`^ {0,${Math.min(3,o-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),Q=new RegExp(`^ {0,${Math.min(3,o-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),b=new RegExp(`^ {0,${Math.min(3,o-1)}}(?:\`\`\`|~~~)`),q=new RegExp(`^ {0,${Math.min(3,o-1)}}#`);for(;e&&(p=e.split(`
`,1)[0],g=p,this.options.pedantic&&(g=g.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  ")),!(b.test(g)||q.test(g)||ne.test(g)||Q.test(e)));){if(g.search(/[^ ]/)>=o||!g.trim())f+=`
`+g.slice(o);else{if(a||u.search(/[^ ]/)>=4||b.test(u)||q.test(u)||Q.test(u))break;f+=`
`+g}!a&&!g.trim()&&(a=!0),i+=p+`
`,e=e.substring(p.length+1),u=g.slice(o)}}R.loose||(c?R.loose=!0:/\n *\n *$/.test(i)&&(c=!0)),this.options.gfm&&(t=/^\[[ xX]\] /.exec(f),t&&(r=t[0]!=="[ ] ",f=f.replace(/^\[[ xX]\] +/,""))),R.items.push({type:"list_item",raw:i,task:!!t,checked:r,loose:!1,text:f}),R.raw+=i}R.items[R.items.length-1].raw=i.trimRight(),R.items[R.items.length-1].text=f.trimRight(),R.raw=R.raw.trimRight();const se=R.items.length;for(l=0;l<se;l++)if(this.lexer.state.top=!1,R.items[l].tokens=this.lexer.blockTokens(R.items[l].text,[]),!R.loose){const ne=R.items[l].tokens.filter(b=>b.type==="space"),Q=ne.length>0&&ne.some(b=>/\n.*\n/.test(b.raw));R.loose=Q}if(R.loose)for(l=0;l<se;l++)R.items[l].loose=!0;return R}}html(e){const n=this.rules.block.html.exec(e);if(n){const i={type:"html",block:!0,raw:n[0],pre:!this.options.sanitizer&&(n[1]==="pre"||n[1]==="script"||n[1]==="style"),text:n[0]};if(this.options.sanitize){const t=this.options.sanitizer?this.options.sanitizer(n[0]):Z(n[0]);i.type="paragraph",i.text=t,i.tokens=this.lexer.inline(t)}return i}}def(e){const n=this.rules.block.def.exec(e);if(n){const i=n[1].toLowerCase().replace(/\s+/g," "),t=n[2]?n[2].replace(/^<(.*)>$/,"$1").replace(this.rules.inline._escapes,"$1"):"",r=n[3]?n[3].substring(1,n[3].length-1).replace(this.rules.inline._escapes,"$1"):n[3];return{type:"def",tag:i,raw:n[0],href:t,title:r}}}table(e){const n=this.rules.block.table.exec(e);if(n){const i={type:"table",header:ht(n[1]).map(t=>({text:t})),align:n[2].replace(/^ *|\| *$/g,"").split(/ *\| */),rows:n[3]&&n[3].trim()?n[3].replace(/\n[ \t]*$/,"").split(`
...
`}strong(e){return`<strong>${e}</strong>`}em(e){return`<em>${e}</em>`}codespan(e){return`<code>${e}</code>`}br(){return this.options.xhtml?"<br/>":"<br>"}del(e){return`<del>${e}</del>`}link(e,n,i){if(e=mt(this.options.sanitize,this.options.baseUrl,e),e===null)return i;let t='<a href="'+e+'"';return n&&(t+=' title="'+n+'"'),t+=">"+i+"</a>",t}image(e,n,i){if(e=mt(this.options.sanitize,this.options.baseUrl,e),e===null)return i;let t=`<img src="${e}" alt="${i}"`;return n&&(t+=` title="${n}"`),t+=this.options.xhtml?"/>":">",t}text(e){return e}}class je{strong(e){return e}em(e){return e}codespan(e){return e}del(e){return e}html(e){return e}text(e){return e}link(e,n,i){return""+i}image(e,n,i){return""+i}br(){return""}}class Oe{constructor(){this.seen={}}serialize(e){return e.toLowerCase().trim().replace(/<[!\/a-z].*?>/ig,"").replace(/[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,./:;<=>?@[\]^`{|}~]/g,"").replace(/\s/g,"-")}getNextSafeSlug(e,n){let i=e,t=0;if(this.seen.hasOwnProperty(i)){t=this.seen[e];do t++,i=e+"-"+t;while(this.seen.hasOwnProperty(i))}return n||(this.seen[e]=t,this.seen[i]=0),i}slug(e,n={}){const i=this.serialize(e);return this.getNextSafeSlug(i,n.dryrun)}}class ae{constructor(e){this.options=e||me,this.options.renderer=this.options.renderer||new De,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new je,this.slugger=new Oe}static parse(e,n){return new ae(n).parse(e)}static parseInline(e,n){return new ae(n).parseInline(e)}parse(e,n=!0){let i="",t,r,o,l,a,c,u,g,p,f,w,_,V,R,Y,se,ne,Q,b;const q=e.length;for(t=0;t<q;t++){if(f=e[t],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[f.type]&&(b=this.options.extensions.renderers[f.type].call({parser:this},f),b!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(f.type))){i+=b||"";continue}switch(f.type){case"space":continue;case"hr":{i+=this.renderer.hr();continue}case"heading":{i+=this.renderer.heading(this.parseInline(f.tokens),f.depth,zt(this.parseInline(f.tokens,this.textRenderer)),this.slugger);continue}case"code":{i+=this.renderer.code(f.text,f.lang,f.escaped);continue}case"table":{for(g="",u="",l=f.header.length,r=0;r<l;r++)u+=this.renderer.tablecell(this.parseInline(f.header[r].tokens),{header:!0,align:f.align[r]});for(g+=this.renderer.tablerow(u),p="",l=f.rows.length,r=0;r<l;r++){for(c=f.rows[r],u="",a=c.length,o=0;o<a;o++)u+=this.renderer.tablecell(this.parseInline(c[o].tokens),{header:!1,align:f.align[o]});p+=this.renderer.tablerow(u)}i+=this.renderer.table(g,p);continue}case"blockquote":{p=this.parse(f.tokens),i+=this.renderer.blockquote(p);continue}case"list":{for(w=f.ordered,_=f.start,V=f.loose,l=f.items.length,p="",r=0;r<l;r++)Y=f.items[r],se=Y.checked,ne=Y.task,R="",Y.task&&(Q=this.renderer.checkbox(se),V?Y.tokens.length>0&&Y.tokens[0].type==="paragraph"?(Y.tokens[0].text=Q+" "+Y.tokens[0].text,Y.tokens[0].tokens&&Y.tokens[0].tokens.length>0&&Y.tokens[0].tokens[0].type==="text"&&(Y.tokens[0].tokens[0].text=Q+" "+Y.tokens[0].tokens[0].text)):Y.tokens.unshift({type:"text",text:Q}):R+=Q),R+=this.parse(Y.tokens,V),p+=this.renderer.listitem(R,ne,se);i+=this.renderer.list(p,w,_);continue}case"html":{i+=this.renderer.html(f.text,f.block);continue}case"paragraph":{i+=this.renderer.paragraph(this.parseInline(f.tokens));continue}case"text":{for(p=f.tokens?this.parseInline(f.tokens):f.text;t+1<q&&e[t+1].type==="text";)f=e[++t],p+=`
`+(f.tokens?this.parseInline(f.tokens):f.text);i+=n?this.renderer.paragraph(p):p;continue}default:{const ge='Token with "'+f.type+'" type was not found.';if(this.options.silent){console.error(ge);return}else throw new Error(ge)}}}return i}parseInline(e,n){n=n||this.renderer;let i="",t,r,o;const l=e.length;for(t=0;t<l;t++){if(r=e[t],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[r.type]&&(o=this.options.extensions.renderers[r.type].call({parser:this},r),o!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(r.type))){i+=o||"";continue}switch(r.type){case"escape":{i+=n.text(r.text);break}case"html":{i+=n.html(r.text);break}case"link":{i+=n.link(r.href,r.title,this.parseInline(r.tokens,n));break}case"image":{i+=n.image(r.href,r.title,r.text);break}case"strong":{i+=n.strong(this.parseInline(r.tokens,n));break}case"em":{i+=n.em(this.parseInline(r.tokens,n));break}case"codespan":{i+=n.codespan(r.text);break}case"br":{i+=n.br();break}case"del":{i+=n.del(this.parseInline(r.tokens,n));break}case"text":{i+=n.text(r.text);break}default:{const a='Token with "'+r.type+'" type was not found.';if(this.options.silent){console.error(a);return}else throw new Error(a)}}}return i}}class ye{constructor(e){this.options=e||me}preprocess(e){return e}postprocess(e){return e}}J(ye,"passThroughHooks",new Set(["preprocess","postprocess"]));var we,Ge,ze,Ot;class Nn{constructor(...e){Be(this,we);Be(this,ze);J(this,"defaults",Fe());J(this,"options",this.setOptions);J(this,"parse",Te(this,we,Ge).call(this,ie.lex,ae.parse));J(this,"parseInline",Te(this,we,Ge).call(this,ie.lexInline,ae.parseInline));J(this,"Parser",ae);J(this,"parser",ae.parse);J(this,"Renderer",De);J(this,"TextRenderer",je);J(this,"Lexer",ie);J(this,"lexer",ie.lex);J(this,"Tokenizer",Re);J(this,"Slugger",Oe);J(this,"Hooks",ye);this.use(...e)}walkTokens(e,n){let i=[];for(const t of e)switch(i=i.concat(n.call(this,t)),t.type){case"table":{for(const r of t.header)i=i.concat(this.walkTokens(r.tokens,n));for(const r of t.rows)for(const o of r)i=i.concat(this.walkTokens(o.tokens,n));break}case"list":{i=i.concat(this.walkTokens(t.items,n));break}default:this.defaults.extensions&&this.defaults.extensions.childTokens&&this.defaults.extensions.childTokens[t.type]?this.defaults.extensions.childTokens[t.type].forEach(r=>{i=i.concat(this.walkTokens(t[r],n))}):t.tokens&&(i=i.concat(this.walkTokens(t.tokens,n)))}return i}use(...e){const n=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(i=>{const t={...i};if(t.async=this.defaults.async||t.async||!1,i.extensions&&(i.extensions.forEach(r=>{if(!r.name)throw new Error("extension name required");if(r.renderer){const o=n.renderers[r.name];o?n.renderers[r.name]=function(...l){let a=r.renderer.apply(this,l);return a===!1&&(a=o.apply(this,l)),a}:n.renderers[r.name]=r.renderer}if(r.tokenizer){if(!r.level||r.level!=="block"&&r.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");n[r.level]?n[r.level].unshift(r.tokenizer):n[r.level]=[r.tokenizer],r.start&&(r.level==="block"?n.startBlock?n.startBlock.push(r.start):n.startBlock=[r.start]:r.level==="inline"&&(n.startInline?n.startInline.push(r.start):n.startInline=[r.start]))}r.childTokens&&(n.childTokens[r.name]=r.childTokens)}),t.extensions=n),i.renderer){const r=this.defaults.renderer||new De(this.defaults);for(const o in i.renderer){const l=r[o];r[o]=(...a)=>{let c=i.renderer[o].apply(r,a);return c===!1&&(c=l.apply(r,a)),c}}t.renderer=r}if(i.tokenizer){const r=this.defaults.tokenizer||new Re(this.defaults);for(const o in i.tokenizer){const l=r[o];r[o]=(...a)=>{let c=i.tokenizer[o].apply(r,a);return c===!1&&(c=l.apply(r,a)),c}}t.tokenizer=r}if(i.hooks){const r=this.defaults.hooks||new ye;for(const o in i.hooks){const l=r[o];ye.passThroughHooks.has(o)?r[o]=a=>{if(this.defaults.async)return Promise.resolve(i.hooks[o].call(r,a)).then(u=>l.call(r,u));const c=i.hooks[o].call(r,a);return l.call(r,c)}:r[o]=(...a)=>{let c=i.hooks[o].apply(r,a);return c===!1&&(c=l.apply(r,a)),c}}t.hooks=r}if(i.walkTokens){const r=this.defaults.walkTokens;t.walkTokens=function(o){let l=[];return l.push(i.walkTokens.call(this,o)),r&&(l=l.concat(r.call(this,o))),l}}this.defaults={...this.defaults,...t}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}}we=new WeakSet,Ge=function(e,n){return(i,t,r)=>{typeof t=="function"&&(r=t,t=null);const o={...t};t={...this.defaults,...o};const l=Te(this,ze,Ot).call(this,t.silent,t.async,r);if(typeof i>"u"||i===null)return l(new Error("marked(): input parameter is undefined or null"));if(typeof i!="string")return l(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(i)+", string expected"));if(En(t,r),t.hooks&&(t.hooks.options=t),r){const a=t.highlight;let c;try{t.hooks&&(i=t.hooks.preprocess(i)),c=e(i,t)}catch(p){return l(p)}const u=p=>{let f;if(!p)try{t.walkTokens&&this.walkTokens(c,t.walkTokens),f=n(c,t),t.hooks&&(f=t.hooks.postprocess(f))}catch(w){p=w}return t.highlight=a,p?l(p):r(null,f)};if(!a||a.length<3||(delete t.highlight,!c.length))return u();let g=0;this.walkTokens(c,p=>{p.type==="code"&&(g++,setTimeout(()=>{a(p.text,p.lang,(f,w)=>{if(f)return u(f);w!=null&&w!==p.text&&(p.text=w,p.escaped=!0),g--,g===0&&u()})},0))}),g===0&&u();return}if(t.async)return Promise.resolve(t.hooks?t.hooks.preprocess(i):i).then(a=>e(a,t)).then(a=>t.walkTokens?Promise.all(this.walkTokens(a,t.walkTokens)).then(()=>a):a).then(a=>n(a,t)).then(a=>t.hooks?t.hooks.postprocess(a):a).catch(l);try{t.hooks&&(i=t.hooks.preprocess(i));const a=e(i,t);t.walkTokens&&this.walkTokens(a,t.walkTokens);let c=n(a,t);return t.hooks&&(c=t.hooks.postprocess(c)),c}catch(a){return l(a)}}},ze=new WeakSet,Ot=function(e,n,i){return t=>{if(t.message+=`
Please report this to https://github.com/markedjs/marked.`,e){const r="<p>An error occurred:</p><pre>"+Z(t.message+"",!0)+"</pre>";if(n)return Promise.resolve(r);if(i){i(null,r);return}return r}if(n)return Promise.reject(t);if(i){i(t);return}throw t}};const he=new Nn(me);function E(s,e,n){return he.parse(s,e,n)}E.options=E.setOptions=function(s){return he.setOptions(s),E.defaults=he.defaults,Rt(E.defaults),E};E.getDefaults=Fe;E.defaults=me;E.use=function(...s){return he.use(...s),E.defaults=he.defaults,Rt(E.defaults),E};E.walkTokens=function(s,e){return he.walkTokens(s,e)};E.parseInline=he.parseInline;E.Parser=ae;E.parser=ae.parse;E.Renderer=De;E.TextRenderer=je;E.Lexer=ie;E.lexer=ie.lex;E.Tokenizer=Re;E.Slugger=Oe;E.Hooks=ye;E.parse=E;E.options;E.setOptions;E.use;E.walkTokens;E.parseInline;ae.parse;ie.lex;const Bt={};function qn(s){let e;return{c(){e=be(s[1])},l(n){e=ve(n,s[1])},m(n,i){y(n,e,i)},p(n,i){i&2&&ke(e,n[1])},i:K,o:K,d(n){n&&m(e)}}}function Fn(s){let e,n;const i=s[5].default,t=j(i,s,s[4],null);return{c(){e=P("h6"),t&&t.c(),this.h()},l(r){e=C(r,"H6",{id:!0});var o=D(e);t&&t.l(o),o.forEach(m),this.h()},h(){T(e,"id",s[2])},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,o){t&&t.p&&(!n||o&16)&&L(t,i,r,r[4],n?H(i,r[4],o,null):W(r[4]),null),(!n||o&4)&&T(e,"id",r[2])},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function jn(s){let e,n;const i=s[5].default,t=j(i,s,s[4],null);return{c(){e=P("h5"),t&&t.c(),this.h()},l(r){e=C(r,"H5",{id:!0});var o=D(e);t&&t.l(o),o.forEach(m),this.h()},h(){T(e,"id",s[2])},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,o){t&&t.p&&(!n||o&16)&&L(t,i,r,r[4],n?H(i,r[4],o,null):W(r[4]),null),(!n||o&4)&&T(e,"id",r[2])},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function Ln(s){let e,n;const i=s[5].default,t=j(i,s,s[4],null);return{c(){e=P("h4"),t&&t.c(),this.h()},l(r){e=C(r,"H4",{id:!0});var o=D(e);t&&t.l(o),o.forEach(m),this.h()},h(){T(e,"id",s[2])},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,o){t&&t.p&&(!n||o&16)&&L(t,i,r,r[4],n?H(i,r[4],o,null):W(r[4]),null),(!n||o&4)&&T(e,"id",r[2])},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function Wn(s){let e,n;const i=s[5].default,t=j(i,s,s[4],null);return{c(){e=P("h3"),t&&t.c(),this.h()},l(r){e=C(r,"H3",{id:!0});var o=D(e);t&&t.l(o),o.forEach(m),this.h()},h(){T(e,"id",s[2])},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,o){t&&t.p&&(!n||o&16)&&L(t,i,r,r[4],n?H(i,r[4],o,null):W(r[4]),null),(!n||o&4)&&T(e,"id",r[2])},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function Hn(s){let e,n;const i=s[5].default,t=j(i,s,s[4],null);return{c(){e=P("h2"),t&&t.c(),this.h()},l(r){e=C(r,"H2",{id:!0});var o=D(e);t&&t.l(o),o.forEach(m),this.h()},h(){T(e,"id",s[2])},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,o){t&&t.p&&(!n||o&16)&&L(t,i,r,r[4],n?H(i,r[4],o,null):W(r[4]),null),(!n||o&4)&&T(e,"id",r[2])},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function Kn(s){let e,n;const i=s[5].default,t=j(i,s,s[4],null);return{c(){e=P("h1"),t&&t.c(),this.h()},l(r){e=C(r,"H1",{id:!0});var o=D(e);t&&t.l(o),o.forEach(m),this.h()},h(){T(e,"id",s[2])},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,o){t&&t.p&&(!n||o&16)&&L(t,i,r,r[4],n?H(i,r[4],o,null):W(r[4]),null),(!n||o&4)&&T(e,"id",r[2])},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function Vn(s){let e,n,i,t;const r=[Kn,Hn,Wn,Ln,jn,Fn,qn],o=[];function l(a,c){return a[0]===1?0:a[0]===2?1:a[0]===3?2:a[0]===4?3:a[0]===5?4:a[0]===6?5:6}return e=l(s),n=o[e]=r[e](s),{c(){n.c(),i=k()},l(a){n.l(a),i=k()},m(a,c){o[e].m(a,c),y(a,i,c),t=!0},p(a,[c]){let u=e;e=l(a),e===u?o[e].p(a,c):(M(),d(o[u],1,1,()=>{o[u]=null}),G(),n=o[e],n?n.p(a,c):(n=o[e]=r[e](a),n.c()),h(n,1),n.m(i.parentNode,i))},i(a){t||(h(n),t=!0)},o(a){d(n),t=!1},d(a){a&&m(i),o[e].d(a)}}}function Yn(s,e,n){let i,{$$slots:t={},$$scope:r}=e,{depth:o}=e,{raw:l}=e,{text:a}=e;const{slug:c,getOptions:u}=Wt(Bt),g=u();return s.$$set=p=>{"depth"in p&&n(0,o=p.depth),"raw"in p&&n(1,l=p.raw),"text"in p&&n(3,a=p.text),"$$scope"in p&&n(4,r=p.$$scope)},s.$$.update=()=>{s.$$.dirty&8&&n(2,i=g.headerIds?g.headerPrefix+c(a):void 0)},[o,l,i,a,r,t]}class Un extends O{constructor(e){super(),B(this,e,Yn,Vn,z,{depth:0,raw:1,text:3})}}function Zn(s){let e,n;const i=s[1].default,t=j(i,s,s[0],null);return{c(){e=P("p"),t&&t.c()},l(r){e=C(r,"P",{});var o=D(e);t&&t.l(o),o.forEach(m)},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,[o]){t&&t.p&&(!n||o&1)&&L(t,i,r,r[0],n?H(i,r[0],o,null):W(r[0]),null)},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function Jn(s,e,n){let{$$slots:i={},$$scope:t}=e;return s.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class Qn extends O{constructor(e){super(),B(this,e,Jn,Zn,z,{})}}function Xn(s){let e;const n=s[3].default,i=j(n,s,s[2],null);return{c(){i&&i.c()},l(t){i&&i.l(t)},m(t,r){i&&i.m(t,r),e=!0},p(t,[r]){i&&i.p&&(!e||r&4)&&L(i,n,t,t[2],e?H(n,t[2],r,null):W(t[2]),null)},i(t){e||(h(i,t),e=!0)},o(t){d(i,t),e=!1},d(t){i&&i.d(t)}}}function ei(s,e,n){let{$$slots:i={},$$scope:t}=e,{text:r}=e,{raw:o}=e;return s.$$set=l=>{"text"in l&&n(0,r=l.text),"raw"in l&&n(1,o=l.raw),"$$scope"in l&&n(2,t=l.$$scope)},[r,o,t,i]}class ti extends O{constructor(e){super(),B(this,e,ei,Xn,z,{text:0,raw:1})}}function ni(s){let e,n;return{c(){e=P("img"),this.h()},l(i){e=C(i,"IMG",{src:!0,title:!0,alt:!0}),this.h()},h(){xe(e.src,n=s[0])||T(e,"src",n),T(e,"title",s[1]),T(e,"alt",s[2])},m(i,t){y(i,e,t)},p(i,[t]){t&1&&!xe(e.src,n=i[0])&&T(e,"src",n),t&2&&T(e,"title",i[1]),t&4&&T(e,"alt",i[2])},i:K,o:K,d(i){i&&m(e)}}}function ii(s,e,n){let{href:i=""}=e,{title:t=void 0}=e,{text:r=""}=e;return s.$$set=o=>{"href"in o&&n(0,i=o.href),"title"in o&&n(1,t=o.title),"text"in o&&n(2,r=o.text)},[i,t,r]}class ri extends O{constructor(e){super(),B(this,e,ii,ni,z,{href:0,title:1,text:2})}}function oi(s){let e,n;const i=s[3].default,t=j(i,s,s[2],null);return{c(){e=P("a"),t&&t.c(),this.h()},l(r){e=C(r,"A",{href:!0,title:!0});var o=D(e);t&&t.l(o),o.forEach(m),this.h()},h(){T(e,"href",s[0]),T(e,"title",s[1])},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,[o]){t&&t.p&&(!n||o&4)&&L(t,i,r,r[2],n?H(i,r[2],o,null):W(r[2]),null),(!n||o&1)&&T(e,"href",r[0]),(!n||o&2)&&T(e,"title",r[1])},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function ai(s,e,n){let{$$slots:i={},$$scope:t}=e,{href:r=""}=e,{title:o=void 0}=e;return s.$$set=l=>{"href"in l&&n(0,r=l.href),"title"in l&&n(1,o=l.title),"$$scope"in l&&n(2,t=l.$$scope)},[r,o,t,i]}class si extends O{constructor(e){super(),B(this,e,ai,oi,z,{href:0,title:1})}}function li(s){let e,n;const i=s[1].default,t=j(i,s,s[0],null);return{c(){e=P("em"),t&&t.c()},l(r){e=C(r,"EM",{});var o=D(e);t&&t.l(o),o.forEach(m)},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,[o]){t&&t.p&&(!n||o&1)&&L(t,i,r,r[0],n?H(i,r[0],o,null):W(r[0]),null)},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function ci(s,e,n){let{$$slots:i={},$$scope:t}=e;return s.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class ui extends O{constructor(e){super(),B(this,e,ci,li,z,{})}}function mi(s){let e,n;const i=s[1].default,t=j(i,s,s[0],null);return{c(){e=P("del"),t&&t.c()},l(r){e=C(r,"DEL",{});var o=D(e);t&&t.l(o),o.forEach(m)},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,[o]){t&&t.p&&(!n||o&1)&&L(t,i,r,r[0],n?H(i,r[0],o,null):W(r[0]),null)},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function hi(s,e,n){let{$$slots:i={},$$scope:t}=e;return s.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class di extends O{constructor(e){super(),B(this,e,hi,mi,z,{})}}function pi(s){let e,n=s[0].replace(/`/g,"")+"",i;return{c(){e=P("code"),i=be(n)},l(t){e=C(t,"CODE",{});var r=D(e);i=ve(r,n),r.forEach(m)},m(t,r){y(t,e,r),ce(e,i)},p(t,[r]){r&1&&n!==(n=t[0].replace(/`/g,"")+"")&&ke(i,n)},i:K,o:K,d(t){t&&m(e)}}}function fi(s,e,n){let{raw:i}=e;return s.$$set=t=>{"raw"in t&&n(0,i=t.raw)},[i]}class gi extends O{constructor(e){super(),B(this,e,fi,pi,z,{raw:0})}}function yi(s){let e,n;const i=s[1].default,t=j(i,s,s[0],null);return{c(){e=P("strong"),t&&t.c()},l(r){e=C(r,"STRONG",{});var o=D(e);t&&t.l(o),o.forEach(m)},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,[o]){t&&t.p&&(!n||o&1)&&L(t,i,r,r[0],n?H(i,r[0],o,null):W(r[0]),null)},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function Si(s,e,n){let{$$slots:i={},$$scope:t}=e;return s.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class wi extends O{constructor(e){super(),B(this,e,Si,yi,z,{})}}function bi(s){let e,n;const i=s[1].default,t=j(i,s,s[0],null);return{c(){e=P("table"),t&&t.c()},l(r){e=C(r,"TABLE",{});var o=D(e);t&&t.l(o),o.forEach(m)},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,[o]){t&&t.p&&(!n||o&1)&&L(t,i,r,r[0],n?H(i,r[0],o,null):W(r[0]),null)},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function vi(s,e,n){let{$$slots:i={},$$scope:t}=e;return s.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class ki extends O{constructor(e){super(),B(this,e,vi,bi,z,{})}}function Ti(s){let e,n;const i=s[1].default,t=j(i,s,s[0],null);return{c(){e=P("thead"),t&&t.c()},l(r){e=C(r,"THEAD",{});var o=D(e);t&&t.l(o),o.forEach(m)},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,[o]){t&&t.p&&(!n||o&1)&&L(t,i,r,r[0],n?H(i,r[0],o,null):W(r[0]),null)},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function _i(s,e,n){let{$$slots:i={},$$scope:t}=e;return s.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class Pi extends O{constructor(e){super(),B(this,e,_i,Ti,z,{})}}function Ci(s){let e,n;const i=s[1].default,t=j(i,s,s[0],null);return{c(){e=P("tbody"),t&&t.c()},l(r){e=C(r,"TBODY",{});var o=D(e);t&&t.l(o),o.forEach(m)},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,[o]){t&&t.p&&(!n||o&1)&&L(t,i,r,r[0],n?H(i,r[0],o,null):W(r[0]),null)},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function Ai(s,e,n){let{$$slots:i={},$$scope:t}=e;return s.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class xi extends O{constructor(e){super(),B(this,e,Ai,Ci,z,{})}}function Ii(s){let e,n;const i=s[1].default,t=j(i,s,s[0],null);return{c(){e=P("tr"),t&&t.c()},l(r){e=C(r,"TR",{});var o=D(e);t&&t.l(o),o.forEach(m)},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,[o]){t&&t.p&&(!n||o&1)&&L(t,i,r,r[0],n?H(i,r[0],o,null):W(r[0]),null)},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function Ri(s,e,n){let{$$slots:i={},$$scope:t}=e;return s.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class Di extends O{constructor(e){super(),B(this,e,Ri,Ii,z,{})}}function $i(s){let e,n;const i=s[3].default,t=j(i,s,s[2],null);return{c(){e=P("td"),t&&t.c(),this.h()},l(r){e=C(r,"TD",{align:!0});var o=D(e);t&&t.l(o),o.forEach(m),this.h()},h(){T(e,"align",s[1])},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,o){t&&t.p&&(!n||o&4)&&L(t,i,r,r[2],n?H(i,r[2],o,null):W(r[2]),null),(!n||o&2)&&T(e,"align",r[1])},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function zi(s){let e,n;const i=s[3].default,t=j(i,s,s[2],null);return{c(){e=P("th"),t&&t.c(),this.h()},l(r){e=C(r,"TH",{align:!0});var o=D(e);t&&t.l(o),o.forEach(m),this.h()},h(){T(e,"align",s[1])},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,o){t&&t.p&&(!n||o&4)&&L(t,i,r,r[2],n?H(i,r[2],o,null):W(r[2]),null),(!n||o&2)&&T(e,"align",r[1])},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function Oi(s){let e,n,i,t;const r=[zi,$i],o=[];function l(a,c){return a[0]?0:1}return e=l(s),n=o[e]=r[e](s),{c(){n.c(),i=k()},l(a){n.l(a),i=k()},m(a,c){o[e].m(a,c),y(a,i,c),t=!0},p(a,[c]){let u=e;e=l(a),e===u?o[e].p(a,c):(M(),d(o[u],1,1,()=>{o[u]=null}),G(),n=o[e],n?n.p(a,c):(n=o[e]=r[e](a),n.c()),h(n,1),n.m(i.parentNode,i))},i(a){t||(h(n),t=!0)},o(a){d(n),t=!1},d(a){a&&m(i),o[e].d(a)}}}function Bi(s,e,n){let{$$slots:i={},$$scope:t}=e,{header:r}=e,{align:o}=e;return s.$$set=l=>{"header"in l&&n(0,r=l.header),"align"in l&&n(1,o=l.align),"$$scope"in l&&n(2,t=l.$$scope)},[r,o,t,i]}class Ei extends O{constructor(e){super(),B(this,e,Bi,Oi,z,{header:0,align:1})}}function Mi(s){let e,n;const i=s[3].default,t=j(i,s,s[2],null);return{c(){e=P("ul"),t&&t.c()},l(r){e=C(r,"UL",{});var o=D(e);t&&t.l(o),o.forEach(m)},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,o){t&&t.p&&(!n||o&4)&&L(t,i,r,r[2],n?H(i,r[2],o,null):W(r[2]),null)},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function Gi(s){let e,n;const i=s[3].default,t=j(i,s,s[2],null);return{c(){e=P("ol"),t&&t.c(),this.h()},l(r){e=C(r,"OL",{start:!0});var o=D(e);t&&t.l(o),o.forEach(m),this.h()},h(){T(e,"start",s[1])},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,o){t&&t.p&&(!n||o&4)&&L(t,i,r,r[2],n?H(i,r[2],o,null):W(r[2]),null),(!n||o&2)&&T(e,"start",r[1])},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function Ni(s){let e,n,i,t;const r=[Gi,Mi],o=[];function l(a,c){return a[0]?0:1}return e=l(s),n=o[e]=r[e](s),{c(){n.c(),i=k()},l(a){n.l(a),i=k()},m(a,c){o[e].m(a,c),y(a,i,c),t=!0},p(a,[c]){let u=e;e=l(a),e===u?o[e].p(a,c):(M(),d(o[u],1,1,()=>{o[u]=null}),G(),n=o[e],n?n.p(a,c):(n=o[e]=r[e](a),n.c()),h(n,1),n.m(i.parentNode,i))},i(a){t||(h(n),t=!0)},o(a){d(n),t=!1},d(a){a&&m(i),o[e].d(a)}}}function qi(s,e,n){let{$$slots:i={},$$scope:t}=e,{ordered:r}=e,{start:o}=e;return s.$$set=l=>{"ordered"in l&&n(0,r=l.ordered),"start"in l&&n(1,o=l.start),"$$scope"in l&&n(2,t=l.$$scope)},[r,o,t,i]}class Fi extends O{constructor(e){super(),B(this,e,qi,Ni,z,{ordered:0,start:1})}}function ji(s){let e,n;const i=s[1].default,t=j(i,s,s[0],null);return{c(){e=P("li"),t&&t.c()},l(r){e=C(r,"LI",{});var o=D(e);t&&t.l(o),o.forEach(m)},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,[o]){t&&t.p&&(!n||o&1)&&L(t,i,r,r[0],n?H(i,r[0],o,null):W(r[0]),null)},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function Li(s,e,n){let{$$slots:i={},$$scope:t}=e;return s.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class Wi extends O{constructor(e){super(),B(this,e,Li,ji,z,{})}}function Hi(s){let e;return{c(){e=P("hr")},l(n){e=C(n,"HR",{})},m(n,i){y(n,e,i)},p:K,i:K,o:K,d(n){n&&m(e)}}}class Ki extends O{constructor(e){super(),B(this,e,null,Hi,z,{})}}function Vi(s){let e,n;return{c(){e=new Ct(!1),n=k(),this.h()},l(i){e=At(i,!1),n=k(),this.h()},h(){e.a=n},m(i,t){e.m(s[0],i,t),y(i,n,t)},p(i,[t]){t&1&&e.p(i[0])},i:K,o:K,d(i){i&&(m(n),e.d())}}}function Yi(s,e,n){let{text:i}=e;return s.$$set=t=>{"text"in t&&n(0,i=t.text)},[i]}class Ui extends O{constructor(e){super(),B(this,e,Yi,Vi,z,{text:0})}}function Zi(s){let e,n;const i=s[1].default,t=j(i,s,s[0],null);return{c(){e=P("blockquote"),t&&t.c()},l(r){e=C(r,"BLOCKQUOTE",{});var o=D(e);t&&t.l(o),o.forEach(m)},m(r,o){y(r,e,o),t&&t.m(e,null),n=!0},p(r,[o]){t&&t.p&&(!n||o&1)&&L(t,i,r,r[0],n?H(i,r[0],o,null):W(r[0]),null)},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function Ji(s,e,n){let{$$slots:i={},$$scope:t}=e;return s.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class Qi extends O{constructor(e){super(),B(this,e,Ji,Zi,z,{})}}function Xi(s){let e,n,i;return{c(){e=P("pre"),n=P("code"),i=be(s[1]),this.h()},l(t){e=C(t,"PRE",{class:!0});var r=D(e);n=C(r,"CODE",{});var o=D(n);i=ve(o,s[1]),o.forEach(m),r.forEach(m),this.h()},h(){T(e,"class",s[0])},m(t,r){y(t,e,r),ce(e,n),ce(n,i)},p(t,[r]){r&2&&ke(i,t[1]),r&1&&T(e,"class",t[0])},i:K,o:K,d(t){t&&m(e)}}}function er(s,e,n){let{lang:i}=e,{text:t}=e;return s.$$set=r=>{"lang"in r&&n(0,i=r.lang),"text"in r&&n(1,t=r.text)},[i,t]}class tr extends O{constructor(e){super(),B(this,e,er,Xi,z,{lang:0,text:1})}}function nr(s){let e,n;const i=s[1].default,t=j(i,s,s[0],null);return{c(){e=P("br"),t&&t.c()},l(r){e=C(r,"BR",{}),t&&t.l(r)},m(r,o){y(r,e,o),t&&t.m(r,o),n=!0},p(r,[o]){t&&t.p&&(!n||o&1)&&L(t,i,r,r[0],n?H(i,r[0],o,null):W(r[0]),null)},i(r){n||(h(t,r),n=!0)},o(r){d(t,r),n=!1},d(r){r&&m(e),t&&t.d(r)}}}function ir(s,e,n){let{$$slots:i={},$$scope:t}=e;return s.$$set=r=>{"$$scope"in r&&n(0,t=r.$$scope)},[t,i]}class rr extends O{constructor(e){super(),B(this,e,ir,nr,z,{})}}const or={heading:Un,paragraph:Qn,text:ti,image:ri,link:si,em:ui,strong:wi,codespan:gi,del:di,table:ki,tablehead:Pi,tablebody:xi,tablerow:Di,tablecell:Ei,list:Fi,orderedlistitem:null,unorderedlistitem:null,listitem:Wi,hr:Ki,html:Ui,blockquote:Qi,code:tr,br:rr},ar={baseUrl:null,breaks:!1,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartLists:!1,smartypants:!1,tokenizer:null,xhtml:!1};function sr(s){let e,n;return e=new de({props:{tokens:s[0],renderers:s[1]}}),{c(){A(e.$$.fragment)},l(i){N(e.$$.fragment,i)},m(i,t){x(e,i,t),n=!0},p(i,[t]){const r={};t&1&&(r.tokens=i[0]),t&2&&(r.renderers=i[1]),e.$set(r)},i(i){n||(h(e.$$.fragment,i),n=!0)},o(i){d(e.$$.fragment,i),n=!1},d(i){I(e,i)}}}function lr(s,e,n){let i,t,r,o,{source:l=[]}=e,{renderers:a={}}=e,{options:c={}}=e,{isInline:u=!1}=e;const g=Ht();let p,f,w;return Kt(Bt,{slug:_=>t?t.slug(_):"",getOptions:()=>r}),Pt(()=>{n(7,w=!0)}),s.$$set=_=>{"source"in _&&n(2,l=_.source),"renderers"in _&&n(3,a=_.renderers),"options"in _&&n(4,c=_.options),"isInline"in _&&n(5,u=_.isInline)},s.$$.update=()=>{s.$$.dirty&4&&n(8,i=Array.isArray(l)),s.$$.dirty&4&&(t=l?new Oe:void 0),s.$$.dirty&16&&n(9,r={...ar,...c}),s.$$.dirty&869&&(i?n(0,p=l):(n(6,f=new ie(r)),n(0,p=u?f.inlineTokens(l):f.lex(l)),g("parsed",{tokens:p}))),s.$$.dirty&8&&n(1,o={...or,...a}),s.$$.dirty&385&&w&&!i&&g("parsed",{tokens:p})},[p,o,l,a,c,u,f,w,i,r]}class cr extends O{constructor(e){super(),B(this,e,lr,sr,z,{source:2,renderers:3,options:4,isInline:5})}}const ur={ational:"ate",tional:"tion",enci:"ence",anci:"ance",izer:"ize",bli:"ble",alli:"al",entli:"ent",eli:"e",ousli:"ous",ization:"ize",ation:"ate",ator:"ate",alism:"al",iveness:"ive",fulness:"ful",ousness:"ous",aliti:"al",iviti:"ive",biliti:"ble",logi:"log"},mr={icate:"ic",ative:"",alize:"al",iciti:"ic",ical:"ic",ful:"",ness:""},hr="[^aeiou]",Le="[aeiouy]",ue="("+hr+"[^aeiouy]*)",$e="("+Le+"[aeiou]*)",Ee=new RegExp("^"+ue+"?"+$e+ue),dr=new RegExp("^"+ue+"?"+$e+ue+$e+"?$"),Pe=new RegExp("^"+ue+"?("+$e+ue+"){2,}"),ft=new RegExp("^"+ue+"?"+Le),gt=new RegExp("^"+ue+Le+"[^aeiouwxy]$"),pr=/ll$/,fr=/^(.+?)e$/,gr=/^(.+?)y$/,yr=/^(.+?(s|t))(ion)$/,Sr=/^(.+?)(ed|ing)$/,wr=/(at|bl|iz)$/,br=/^(.+?)eed$/,vr=/^.+?[^s]s$/,kr=/^.+?(ss|i)es$/,Tr=/([^aeiouylsz])\1$/,_r=/^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/,Pr=/^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,Cr=/^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/;function Ar(s){let e=String(s).toLowerCase();if(e.length<3)return e;let n=!1;e.codePointAt(0)===121&&(n=!0,e="Y"+e.slice(1)),kr.test(e)?e=e.slice(0,-2):vr.test(e)&&(e=e.slice(0,-1));let i;return(i=br.exec(e))?Ee.test(i[1])&&(e=e.slice(0,-1)):(i=Sr.exec(e))&&ft.test(i[1])&&(e=i[1],wr.test(e)?e+="e":Tr.test(e)?e=e.slice(0,-1):gt.test(e)&&(e+="e")),(i=gr.exec(e))&&ft.test(i[1])&&(e=i[1]+"i"),(i=_r.exec(e))&&Ee.test(i[1])&&(e=i[1]+ur[i[2]]),(i=Pr.exec(e))&&Ee.test(i[1])&&(e=i[1]+mr[i[2]]),(i=Cr.exec(e))?Pe.test(i[1])&&(e=i[1]):(i=yr.exec(e))&&Pe.test(i[1])&&(e=i[1]),(i=fr.exec(e))&&(Pe.test(i[1])||dr.test(i[1])&&!gt.test(i[1]))&&(e=i[1]),pr.test(e)&&Pe.test(e)&&(e=e.slice(0,-1)),n&&(e="y"+e.slice(1)),e}const fe=It(""),Et=qe(fe,s=>s.toLowerCase());qe(Et,s=>Ar(s));function xr(s){let e,n;return{c(){e=P("img"),this.h()},l(i){e=C(i,"IMG",{src:!0,title:!0,alt:!0,class:!0}),this.h()},h(){xe(e.src,n=s[0].replace("../static",""))||T(e,"src",n),T(e,"title",s[1]),T(e,"alt",s[2]),T(e,"class","svelte-1gl2z3f")},m(i,t){y(i,e,t)},p(i,[t]){t&1&&!xe(e.src,n=i[0].replace("../static",""))&&T(e,"src",n),t&2&&T(e,"title",i[1]),t&4&&T(e,"alt",i[2])},i:K,o:K,d(i){i&&m(e)}}}function Ir(s,e,n){let{href:i=""}=e,{title:t=""}=e,{text:r=""}=e;return s.$$set=o=>{"href"in o&&n(0,i=o.href),"title"in o&&n(1,t=o.title),"text"in o&&n(2,r=o.text)},[i,t,r]}class Rr extends O{constructor(e){super(),B(this,e,Ir,xr,z,{href:0,title:1,text:2})}}function yt(s){let e,n;return e=new cr({props:{source:s[0]+" ",renderers:{image:Rr}}}),{c(){A(e.$$.fragment)},l(i){N(e.$$.fragment,i)},m(i,t){x(e,i,t),n=!0},p(i,t){const r={};t&1&&(r.source=i[0]+" "),e.$set(r)},i(i){n||(h(e.$$.fragment,i),n=!0)},o(i){d(e.$$.fragment,i),n=!1},d(i){I(e,i)}}}function Dr(s){let e,n,i=s[0].length!=0&&yt(s);return{c(){i&&i.c(),e=k()},l(t){i&&i.l(t),e=k()},m(t,r){i&&i.m(t,r),y(t,e,r),n=!0},p(t,[r]){t[0].length!=0?i?(i.p(t,r),r&1&&h(i,1)):(i=yt(t),i.c(),h(i,1),i.m(e.parentNode,e)):i&&(M(),d(i,1,1,()=>{i=null}),G())},i(t){n||(h(i),n=!0)},o(t){d(i),n=!1},d(t){t&&m(e),i&&i.d(t)}}}const $r=/\[[#A-Za-z:,?-]+\]/gi;function zr(s,e){return s!=null&&s.filter(n=>n.toLowerCase().includes(e.toLowerCase())).length>0}function Or(s,e){return s.toLowerCase().includes(e.toLowerCase())}function Br(s){let e=s.match($r);return e!=null?e.flatMap(n=>n.substring(1,n.length-1).split(",")):[]}function Er(s,e,n){let i,t,r,o,l,a,c;Se(s,Ut,w=>n(7,a=w)),Se(s,Et,w=>n(4,c=w));let{block:u}=e;function g(w,_){let V="";for(let R=0;R<_.length;R++)f(_[R],o[R],w)&&(V+=_[R]+`
`);return V.trim()}function p(){return a.keepHeader&&i}function f(w,_,V){return V==""||p()||Or(w,V)||zr(_,V)}return s.$$set=w=>{"block"in w&&n(1,u=w.block)},s.$$.update=()=>{s.$$.dirty&2&&(i=u.trim().startsWith("#")),s.$$.dirty&2&&n(3,t=u.split(`
`)),s.$$.dirty&8&&n(2,r=t.map(w=>w.replace(/(\[[#A-Za-z:,?-]+\])/g,""))),s.$$.dirty&8&&(o=t.map(w=>Br(w))),s.$$.dirty&20&&n(0,l=g(c,r))},[l,u,r,t,c]}class Mr extends O{constructor(e){super(),B(this,e,Er,Dr,z,{block:1})}}function St(s,e,n){const i=s.slice();return i[1]=e[n],i}function wt(s){let e,n;return e=new Mr({props:{block:s[1]}}),{c(){A(e.$$.fragment)},l(i){N(e.$$.fragment,i)},m(i,t){x(e,i,t),n=!0},p(i,t){const r={};t&1&&(r.block=i[1]),e.$set(r)},i(i){n||(h(e.$$.fragment,i),n=!0)},o(i){d(e.$$.fragment,i),n=!1},d(i){I(e,i)}}}function Gr(s){let e,n,i=U(s[0]),t=[];for(let o=0;o<i.length;o+=1)t[o]=wt(St(s,i,o));const r=o=>d(t[o],1,1,()=>{t[o]=null});return{c(){for(let o=0;o<t.length;o+=1)t[o].c();e=k()},l(o){for(let l=0;l<t.length;l+=1)t[l].l(o);e=k()},m(o,l){for(let a=0;a<t.length;a+=1)t[a]&&t[a].m(o,l);y(o,e,l),n=!0},p(o,[l]){if(l&1){i=U(o[0]);let a;for(a=0;a<i.length;a+=1){const c=St(o,i,a);t[a]?(t[a].p(c,l),h(t[a],1)):(t[a]=wt(c),t[a].c(),h(t[a],1),t[a].m(e.parentNode,e))}for(M(),a=i.length;a<t.length;a+=1)r(a);G()}},i(o){if(!n){for(let l=0;l<i.length;l+=1)h(t[l]);n=!0}},o(o){t=t.filter(Boolean);for(let l=0;l<t.length;l+=1)d(t[l]);n=!1},d(o){o&&m(e),le(t,o)}}}function Nr(s,e,n){let{textBlocks:i}=e;return s.$$set=t=>{"textBlocks"in t&&n(0,i=t.textBlocks)},[i]}class qr extends O{constructor(e){super(),B(this,e,Nr,Gr,z,{textBlocks:0})}}const Fr=`# **Holacracy Constitution**
...
1. A Product Owner[ScrumTeam,ProductOwner] orders the work[ScrumArtefact,ProductBacklog,ProductBacklogItem] for a complex problem into a Product Backlog[ScrumArtefact,ProductBacklog].
2. The Scrum Team[ScrumTeam] turns a selection of the work[SprintBacklogItem,ScrumArtefact,ProductBacklog,ProductBacklogItem] into an Increment[ScrumArtifacts,Increment] of value during a Sprint[ScumEvents,Sprint].
...
- Creating and clearly communicating Product Backlog items[ScrumArtefact,ProductBacklog,ProductBacklogItem];[ScrumTeam,ProductOwner,Accountable]
- Ordering Product Backlog items[ScrumArtefact,ProductBacklog,ProductBacklogItem]; and,[ScrumTeam,ProductOwner,Accountable]
...
The Product Owner[ScrumTeam,ProductOwner] ensures[ProductOwner,Responsible] that attendees[ScumEvents,SprintPlanning,Attendees] are prepared to discuss the most important Product Backlog items[ScrumArtefact,ProductBacklog,ProductBacklogItem] and how they[ScrumArtefact,ProductBacklog,ProductBacklogItem] map to the Product Goal[ScrumArtefact,ProductBacklog,Commitment,ProductGoal].
...
Through discussion with the Product Owner[ScrumTeam,ProductOwner], the Developers[ScrumTeam,Developers] select items[ScrumArtefact,ProductBacklog,ProductBacklogItem] from the Product Backlog[ScrumArtefact,ProductBacklog] to include in the current Sprint[ScumEvents,Sprint].
The Scrum Team[ScrumTeam] may refine[ProductBacklogRefinement] these items[ScrumArtefact,ProductBacklog,ProductBacklogItem] during this process, which increases understanding and confidence.
...
For each selected Product Backlog item[ScrumArtefact,ProductBacklog,ProductBacklogItem], the Developers[ScrumTeam,Developers] plan the work necessary to create an Increment[ScrumArtifacts] that meets the Definition of Done[ScrumArtefact,Increment,Commitment,DefinitionOfDone].
This is often done by decomposing Product Backlog items[ScrumArtefact,ProductBacklog,ProductBacklogItem] into smaller work items[WorkItem] of one day[Timebox] or less.
How this is done is at the sole discretion of the Developers[ScrumTeam,Developers].
No one else tells[NotTheSameAsGivingAdvice] them[ScrumTeam,Developers] how to turn Product Backlog items[ScrumArtefact,ProductBacklog,ProductBacklogItem] into Increments[ScrumArtifacts] of value.

The Sprint Goal[ScrumArtefact,SprintBacklog,Commitment,SprintGoal], the Product Backlog items[ScrumArtefact,ProductBacklog,ProductBacklogItem] selected for the Sprint[ScumEvents,Sprint], plus the plan for delivering[ScrumArtifacts,Increment] them are together referred to as the Sprint Backlog.
...
These commitments[ScrumValues,Commitment,ProductGoal,SprintGoal,ScrumArtefact,Increment,DefinitionOfDone] exist to reinforce empiricism[Empiricism] and the Scrum values[ScrumValues] for the Scrum Team and their stakeholders[Stakeholder].
...
The Product Goal[ScrumArtefact,ProductBacklog,Commitment,ProductGoal] describes a future state of the product[Product] which can serve as a target for the Scrum Team[ScrumTeam] to plan against.
...
The Sprint Backlog is composed of the Sprint Goal[ScrumArtefact,SprintBacklog,Commitment,SprintGoal] (why), the set of Product Backlog items[ScrumArtefact,ProductBacklog,ProductBacklogItem] selected for the Sprint[ScumEvents,Sprint] (what), as well as an actionable plan[WorkItem] for delivering the Increment[ScrumArtifacts,Increment] (how).
...
The moment a Product Backlog item[ScrumArtefact,ProductBacklog,ProductBacklogItem] meets the Definition of Done[ScrumArtefact,Increment,Commitment,DefinitionOfDone], an Increment[ScrumArtifacts,Increment] is born.
...
If a Product Backlog item[ScrumArtefact,ProductBacklog,ProductBacklogItem] does not meet the Definition of Done[ScrumArtefact,Increment,Commitment,DefinitionOfDone], it cannot be released[ScrumArtifacts,Increment] or even presented at the Sprint Review[ScrumEvents,SprintReview].[UnfinishedWork]
...
If it is not an organizational[Organization] standard, the Scrum Team[ScrumTeam] must create a Definition of Done[ScrumArtefact,Increment,Commitment,DefinitionOfDone] appropriate for the product[Product].
...
If there are multiple Scrum Teams[ScrumTeams,ScaledScrum] working together on a product[Product], they[ScrumTeam] must mutually define and comply with the same Definition of Done[ScrumArtefact,Increment,Commitment,DefinitionOfDone].
...
`,Mt=Object.freeze(Object.defineProperty({__proto__:null,Holacracy_Constitution:Fr,Kanban_Guide_2020:jr,Nexus_Guide_2021:Lr,Scrum_At_Scale_Guide_2022:Wr,Scrum_Guide_2017:Hr,Scrum_Guide_2020:Kr},Symbol.toStringTag,{value:"Module"})),Vr=["super circle thereof","circle lead role","resolve priority conflicts","regular tactical meetings","integrative election process","special governance meeting","integrative decision making","decision making process","role lead","broader circle","super circle","anchor circle","circle thereof","add accountabilities","circle lead","lead role","relational agreements","tactical meetings","turn shares","meeting responses","agenda item","individual initiative","governance process","circle member","circle rep","integrative election","election process","amended proposal","governance meeting","special governance","process breakdown","constitution","ratifiers","adopt","authority","organization","rule","process","amend","made","policy","define","partner","governance","relevant","responses","constraints","outputs","duty","acting","article","role","person","fill","lead","purpose","capacity","potential","domain","control","accountable","enact","hold","special","apply","tension","resolve","regularly","action","priority","projects","specific","work","capturing","executing","time","add","circle","make","considered","broader","super","conflict","spend","explicitly","anchor","change","clarify","thereof","remove","invited","automatically","facilitator","secretary","required","meet","serve","assignment","focus","context","default","relative","prioritize","request","share","judgment","item","metrics","progress","impact","reason","include","official","individual","interpret","relational","agreements","tactical","regular","represent","round","participant","turn","allowed","initiative","agenda","discussion","step","violate","permission","counts","limit","stated","member","election","select","rep","integrative","candidate","proposer","reactions","concern","objection","criteria","objector","address","present","believes","nomination","tied","surrogate","duration","breakdown"],Yr=["kanban system members","kanban practices","kanban system","system members","work item","kanban board","controlling wip","flow measures","kanban","guide","delivery","limited","license","definition","flow","based","system","practices","workflow","item","called","members","work","elements","context","time","dow","started","finished","wip","sle","long","board","controlling","measures","WorkInProgress","KanbanBoard","CycleTime"],Ur=["single product backlog","cross team dependencies","nexus integration team","nexus sprint goal","product backlog items","nexus sprint backlog","cross team refinement","nexus sprint planning","nexus daily scrum","nexus sprint review","nexus sprint retrospective","scrum team","nexus framework","scrum framework","scrum guide","single product","product owner","product backlog","integrated increment","cross team","team dependencies","nexus integration","integration team","scrum master","team members","nexus sprint","sprint goal","backlog items","sprint backlog","product goal","integration issues","individual scrum","nexus events","team refinement","sprint planning","nexus daily","daily scrum","sprint review","sprint retrospective","purpose","nexus","guide","product","integrated","work","valuable","framework","scrum","dependencies","multiple","team","org","definition","scale","deliver","single","people","owner","backlog","accountable","events","artifacts","increment","goal","sprint","cross","transparent","communication","feedback","master","members","individual","items","issues","refinement","planning","daily","state","review","commitment","license","ScrumTeams","Accountable","ScrumTeam","CrossTeam","NexusIntegrationTeam"],Zr=["scrum scale guide","single scrum team","cross team dependencies","minimum viable bureaucracy","scrum master cycle","product owner cycle","static docsimages scrum_at_scale_guide_2022","agile operating system","executive action team","action team eat","team process component","scrums master sosm","product owner team","chief product owner","scaled daily scrum","drive continuous improvement","cross team coordination","entire agile organization","product owner organization","scrum master organization","scrum scale","scrum guide","scrum team","sustainable pace","multiple teams","cross team","team dependencies","business agility","scrum master","master cycle","product owner","owner cycle","entire organization","operating system","static docsimages","docsimages scrum_at_scale_guide_2022","reference model","executive metascrum","executive action","action team","team eat","team process","scaled versions","daily scrum","owner team","chief product","continuous improvement","team coordination","strategic vision","backlog prioritization","backlog decomposition","release planning","sutherland jeff","guide","scrum","scale","single","team","deliver","optimal","sustainable","creation","product","process","multiple","number","organization","quality","work","cross","dependencies","business","agile","priorities","framework","coordinate","needed","delivery","change","prioritized","goal","achieve","set","network","function","independent","based","customer","time","make","order","implementing","component","role","event","master","cycle","owner","specific","required","people","complex","environment","transparency","organizational","operating","entire","system","progress","static","docsimages","scrum_at_scale_guide_2022","png","created","reference","model","sprint","sos","leadership","executive","metascrum","action","eat","members","larger","feedback","versions","group","release","po","diagram","daily","planning","backlog","refinement","chief","impediments","continuous","improvement","accountable","removal","stakeholders","metrics","ensure","individual","items","vision","strategic","jeff","sutherland"],Jr=["roles events artifacts","scrum team members","product backlog items","development team members","scrum master service","scrum master serves","scrum master ensures","event takes place","scrum master teaches","selected product backlog","total work remaining","scrum guide","roles events","scrum team","sprint goal","scrum events","sprint planning","daily scrum","sprint review","sprint retrospective","team members","product owner","development team","scrum master","product backlog","backlog items","potentially releasable","product increment","sprint backlog","time box","master ensures","master teaches","upcoming sprint","work needed","total work","work remaining","purpose","scrum","guide","framework","deliver","complex","product","definition","roles","event","artifacts","rules","people","understand","master","process","work","team","develop","release","day","daily","organizing","collaborate","empirical","decisions","based","risk","transparency","inspect","adapt","visible","responsible","resulting","increment","progress","sprint","goal","made","plan","review","retrospective","values","members","stakeholders","owner","accomplish","needed","potentially","backlog","items","ensures","change","set","requirements","end","create","functionality","complete","helping","practices","ways","increase","time","remaining","box","month","shorter","upcoming","meet","selected","order","improvements"],Qr=["scrum team members","product backlog item","scrum master serves","scrum master","product owner","product backlog","scrum team","scrum events","team members","product goal","sprint backlog","sprint goal","backlog items","sprint review","sprint planning","sprint retrospective","shorter sprints","daily scrum","scrum","definition","framework","people","team","complex","problems","master","product","owner","work","backlog","increment","sprint","stakeholders","inspect","create","required","visible","management","empiricism","decisions","needed","event","adaptation","transparency","artifacts","progress","values","commitment","focus","members","developers","time","goal","organization","accountable","plan","day","items","review","helping","daily","shorter","Framework","ExtendScrum","Organization","ScrumPillars","Adaptation","ScrumTeam","ScrumMaster","ProductOwner","ScrumArtefact","ProductBacklog","ProductBacklogItem","SprintBacklogItem","ScrumArtifacts","Increment","ScumEvents","Sprint","Stakeholder","Inspection","ScrumEvent","SprintReview","Cadence","Scrum","Commitment","ProductGoal","SprintGoal","extendScrum","ScumEvent","Lean","WasteReduction","Transparency","Management","Empiricism","ScrumValues","Focus","Learn","SelfManagement","ScrumEvents","Adaption","Emergence","Developers","Courage","Product","DefinitionOfDone","Openness","Respect","ExternalPeople","CrossFunctional","ScrumTeams","ScaledScrum","Responsible","Learning","ReduceComplexity","Accountable","SprintBacklog","Serve","Impediments","Timebox","Uncertainty","OtherMeetings","order","PBI","SprintPlanning","DailyScrum","SprintRetrospective","Forecast","BurnDown","BurnUp","Order","transparency","Attendees","ProductBacklogRefinement","Capacity","WorkItem","NotTheSameAsGivingAdvice","ScrumValue","Ready","Coherence","UnfinishedWork","NoChangesAreAllowed"],Xr=Object.freeze(Object.defineProperty({__proto__:null,Holacracy_Constitution:Vr,Kanban_Guide_2020:Yr,Nexus_Guide_2021:Ur,Scrum_At_Scale_Guide_2022:Zr,Scrum_Guide_2017:Jr,Scrum_Guide_2020:Qr},Symbol.toStringTag,{value:"Module"}));function eo(s){let e,n,i=(s[2]?"Custom Tag: "+s[1]:s[1])+"",t,r;return{c(){e=P("li"),n=new Ct(!1),this.h()},l(o){e=C(o,"LI",{class:!0});var l=D(e);n=At(l,!1),l.forEach(m),this.h()},h(){n.a=null,T(e,"class","autocomplete-items svelte-1jxhqc6"),Ve(e,"autocomplete-active",s[0])},m(o,l){y(o,e,l),n.m(i,e),t||(r=pe(e,"click",s[4]),t=!0)},p(o,[l]){l&6&&i!==(i=(o[2]?"Custom Tag: "+o[1]:o[1])+"")&&n.p(i),l&1&&Ve(e,"autocomplete-active",o[0])},i:K,o:K,d(o){o&&m(e),t=!1,r()}}}function to(s,e,n){let i,t,{itemLabel:r}=e,{highlighted:o}=e;function l(a){_t.call(this,s,a)}return s.$$set=a=>{"itemLabel"in a&&n(3,r=a.itemLabel),"highlighted"in a&&n(0,o=a.highlighted)},s.$$.update=()=>{s.$$.dirty&8&&n(1,i=r.replace(/([a-z])([A-Z])/g,"$1 $2")),s.$$.dirty&10&&n(2,t=r!==i)},[o,i,t,r,l]}class no extends O{constructor(e){super(),B(this,e,to,eo,z,{itemLabel:3,highlighted:0})}}function io(){const{subscribe:s,set:e,update:n}=It(new Set);return{subscribe:s,add:i=>n(t=>t.add(i)),reset:()=>e(new Set)}}const Ne=io(),ro=qe(Ne,s=>Array.from(s).sort((e,n)=>e.localeCompare(n)));function bt(s,e,n){const i=s.slice();return i[11]=e[n],i[13]=n,i}function vt(s){let e,n,i=U(s[2]),t=[];for(let o=0;o<i.length;o+=1)t[o]=kt(bt(s,i,o));const r=o=>d(t[o],1,1,()=>{t[o]=null});return{c(){e=P("ul");for(let o=0;o<t.length;o+=1)t[o].c();this.h()},l(o){e=C(o,"UL",{id:!0,class:!0});var l=D(e);for(let a=0;a<t.length;a+=1)t[a].l(l);l.forEach(m),this.h()},h(){T(e,"id","autocomplete-items-list"),T(e,"class","svelte-yyp99g")},m(o,l){y(o,e,l);for(let a=0;a<t.length;a+=1)t[a]&&t[a].m(e,null);n=!0},p(o,l){if(l&44){i=U(o[2]);let a;for(a=0;a<i.length;a+=1){const c=bt(o,i,a);t[a]?(t[a].p(c,l),h(t[a],1)):(t[a]=kt(c),t[a].c(),h(t[a],1),t[a].m(e,null))}for(M(),a=i.length;a<t.length;a+=1)r(a);G()}},i(o){if(!n){for(let l=0;l<i.length;l+=1)h(t[l]);n=!0}},o(o){t=t.filter(Boolean);for(let l=0;l<t.length;l+=1)d(t[l]);n=!1},d(o){o&&m(e),le(t,o)}}}function kt(s){let e,n;function i(){return s[9](s[11])}return e=new no({props:{itemLabel:s[11],highlighted:s[13]===s[3]}}),e.$on("click",i),{c(){A(e.$$.fragment)},l(t){N(e.$$.fragment,t)},m(t,r){x(e,t,r),n=!0},p(t,r){s=t;const o={};r&4&&(o.itemLabel=s[11]),r&8&&(o.highlighted=s[13]===s[3]),e.$set(o)},i(t){n||(h(e.$$.fragment,t),n=!0)},o(t){d(e.$$.fragment,t),n=!1},d(t){I(e,t)}}}function oo(s){let e,n,i,t,r,o,l,a=s[2].length>0&&vt(s);return{c(){e=P("form"),n=P("div"),i=P("input"),t=ee(),a&&a.c(),this.h()},l(c){e=C(c,"FORM",{autocomplete:!0});var u=D(e);n=C(u,"DIV",{class:!0});var g=D(n);i=C(g,"INPUT",{id:!0,type:!0,placeholder:!0,class:!0}),g.forEach(m),t=te(u),a&&a.l(u),u.forEach(m),this.h()},h(){T(i,"id","item-input"),T(i,"type","search"),T(i,"placeholder","Search Terms"),T(i,"class","svelte-yyp99g"),T(n,"class","autocomplete svelte-yyp99g"),T(e,"autocomplete","off")},m(c,u){y(c,e,u),ce(e,n),ce(n,i),s[7](i),Ae(i,s[0]),ce(e,t),a&&a.m(e,null),r=!0,o||(l=[pe(window,"keydown",s[6]),pe(i,"input",s[8]),pe(i,"input",s[4])],o=!0)},p(c,[u]){u&1&&i.value!==c[0]&&Ae(i,c[0]),c[2].length>0?a?(a.p(c,u),u&4&&h(a,1)):(a=vt(c),a.c(),h(a,1),a.m(e,null)):a&&(M(),d(a,1,1,()=>{a=null}),G())},i(c){r||(h(a),r=!0)},o(c){d(a),r=!1},d(c){c&&m(e),s[7](null),a&&a.d(),o=!1,Tt(l)}}}function ao(s,e){let n=s.toLowerCase().indexOf(e.toLowerCase()),i=s.substring(n,n+e.length),t=`<strong>${i}</strong>`;return s.replaceAll(i,t)}function so(s){return s.replaceAll(/<(.)*?>/g,"")}function lo(s,e,n){let i,t;Se(s,fe,w=>n(0,i=w)),Se(s,ro,w=>n(10,t=w));let r,o=[],l=null;function a(){let w=[];i&&t.forEach(_=>{_.toLowerCase().includes(i.toLowerCase())&&(w=[...w,ao(_,i)])}),n(2,o=w)}function c(w){xt(fe,i=so(w),i),n(2,o=[]),n(3,l=null),document==null||document.querySelector("#item-input").focus()}function u(w){if(w.key==="ArrowDown"&&(l==null||l<=o.length-1))l===null?n(3,l=0):n(3,l+=1);else if(w.key==="ArrowUp"&&l!==null)l===0?n(3,l=o.length-1):n(3,l-=1);else if(w.key==="Enter")c(l===null?i:o[l]);else return}function g(w){Me[w?"unshift":"push"](()=>{r=w,n(1,r)})}function p(){i=this.value,fe.set(i)}const f=w=>c(w);return s.$$.update=()=>{s.$$.dirty&1&&(i||(n(2,o=[]),n(3,l=null)))},[i,r,o,l,a,c,u,g,p,f]}class co extends O{constructor(e){super(),B(this,e,lo,oo,z,{})}}function uo(s){let e,n,i,t="Interactive Agile Guides",r,o,l,a,c,u,g,p,f,w,_,V,R;o=new co({});function Y(b){s[3](b)}let se={options:Object.keys(Mt)};s[0]!==void 0&&(se.selectedGuide=s[0]),u=new Qt({props:se}),Me.push(()=>Ue(u,"selectedGuide",Y)),u.$on("change",s[2]);function ne(b){s[4](b)}let Q={};return s[1]!==void 0&&(Q.textBlocks=s[1]),_=new qr({props:Q}),Me.push(()=>Ue(_,"textBlocks",ne)),{c(){e=P("meta"),n=ee(),i=P("h1"),i.textContent=t,r=ee(),A(o.$$.fragment),l=ee(),a=P("br"),c=ee(),A(u.$$.fragment),p=ee(),f=P("br"),w=ee(),A(_.$$.fragment),this.h()},l(b){const q=Vt("svelte-144h0ef",document.head);e=C(q,"META",{name:!0,content:!0}),q.forEach(m),n=te(b),i=C(b,"H1",{"data-svelte-h":!0}),Yt(i)!=="svelte-drn8q9"&&(i.textContent=t),r=te(b),N(o.$$.fragment,b),l=te(b),a=C(b,"BR",{}),c=te(b),N(u.$$.fragment,b),p=te(b),f=C(b,"BR",{}),w=te(b),N(_.$$.fragment,b),this.h()},h(){document.title="Interactive Agile Guides",T(e,"name","description"),T(e,"content","Interactive Agile Guides")},m(b,q){ce(document.head,e),y(b,n,q),y(b,i,q),y(b,r,q),x(o,b,q),y(b,l,q),y(b,a,q),y(b,c,q),x(u,b,q),y(b,p,q),y(b,f,q),y(b,w,q),x(_,b,q),R=!0},p(b,[q]){const ge={};!g&&q&1&&(g=!0,ge.selectedGuide=b[0],Ye(()=>g=!1)),u.$set(ge);const We={};!V&&q&2&&(V=!0,We.textBlocks=b[1],Ye(()=>V=!1)),_.$set(We)},i(b){R||(h(o.$$.fragment,b),h(u.$$.fragment,b),h(_.$$.fragment,b),R=!0)},o(b){d(o.$$.fragment,b),d(u.$$.fragment,b),d(_.$$.fragment,b),R=!1},d(b){b&&(m(n),m(i),m(r),m(l),m(a),m(c),m(p),m(f),m(w)),m(e),I(o,b),I(u,b),I(_,b)}}}function mo(s,e,n){let i,t;Se(s,fe,p=>n(5,t=p));let r="Scrum_Guide_2020";function o(p){for(const[f,w]of Object.entries(Mt))if(f===p)return w;return"# No matching Guide found"}function l(p){for(const[f,w]of Object.entries(Xr))if(f===p)return w;return[]}function a(){Ne.reset(),xt(fe,t="",t)}function c(p){l(p).forEach(f=>{Ne.add(f)})}function u(p){r=p,n(0,r)}function g(p){i=p,n(1,i),n(0,r)}return s.$$.update=()=>{s.$$.dirty&1&&n(1,i=o(r).split(`

`)),s.$$.dirty&1&&c(r)},[r,i,a,u,g]}class bo extends O{constructor(e){super(),B(this,e,mo,uo,z,{})}}export{bo as component};
